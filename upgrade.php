...
<input type="hidden" name="invoice" value="<?php echo $paymentNumber . ','  . $random . ',5,1'; ?>">
...
<img alt="" border="0" src="https://www.paypalobjects.com/WEBSCR-640-20110306-1/en_US/i/scr/pixel.gif" width="1" height="1">
    ...
    <br/><h2>Premium Benefits</h2><div style="text-align:left;">
    <h4><li>Twice the amount of sub4sub, view4view, lik4like, comment4comment, and watch4watch points.</li></h4>
    <h4><li>Twice the amount of points from refferals.</li></h4>
    <h4><li>3 points for every featured video you watch.</li></h4>
    <h4><li>100 points added toward sub4sub, view4view, watch4watch, and like4like.</li></h4>
    <h4><li>Only $5 for a month of Premium.</li></h4>
	</div>
