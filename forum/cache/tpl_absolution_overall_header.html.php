...
<script type="text/javascript" src="<?php echo (isset($this->_rootref['T_TEMPLATE_PATH'])) ? $this->_rootref['T_TEMPLATE_PATH'] : ''; ?>/dropdown.js"></script>
...
<div id="page-wrap" style="width: <?php echo (isset($this->_tpldata['DEFINE']['.']['ABSOLUTION_BOARD_WIDTH'])) ? $this->_tpldata['DEFINE']['.']['ABSOLUTION_BOARD_WIDTH'] : ''; ?>;">
...
<div id="wrap">
    <div id="header">
	    <div id="header-left">
        <?php if ($this->_tpldata['DEFINE']['.']['LOGO_TYPE'] == ('image')) {  ?>
		...
		<?php } if ($this->_tpldata['DEFINE']['.']['LOGO_TYPE'] == ('text')) {  ?>
		<div id="site-details"><?php echo (isset($this->_rootref['SITENAME'])) ? $this->_rootref['SITENAME'] : ''; ?><br />
		    ...
		    <div id="<?php if (! $this->_rootref['S_USER_LOGGED_IN']) {  ?>formbox<?php } else { ?>header-search-box<?php } ?>">
			    <?php if (! $this->_rootref['S_USER_LOGGED_IN']) {  ?>
				    <form method="post" action="<?php echo (isset($this->_rootref['S_LOGIN_ACTION'])) ? $this->_rootref['S_LOGIN_ACTION'] : ''; ?>">
                        ...
                        <input type="submit" name="login" value="<?php echo ((isset($this->_rootref['L_LOGIN'])) ? $this->_rootref['L_LOGIN'] : ((isset($user->lang['LOGIN'])) ? $user->lang['LOGIN'] : '{ LOGIN }')); ?>" class="quick-login-button" /><br />
	...
	<div class="float-left breadcrumbs"><img src="<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/images/house.png" width="16" height="16" alt="" />
