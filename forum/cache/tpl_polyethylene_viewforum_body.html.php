...
<?php } if ($this->_rootref['S_DISPLAY_ACTIVE']) {  ?>
	...
	<tr>
		<td class="cat" colspan="<?php if ($this->_rootref['S_TOPIC_ICONS']) {  ?>6<?php } else { ?>5<?php } ?>"><span class="nav"><?php echo ((isset($this->_rootref['L_ACTIVE_TOPICS'])) ? $this->_rootref['L_ACTIVE_TOPICS'] : ((isset($user->lang['ACTIVE_TOPICS'])) ? $user->lang['ACTIVE_TOPICS'] : '{ ACTIVE_TOPICS }')); ?></span></td>
	</tr>
	...
	<?php $_topicrow_count = (isset($this->_tpldata['topicrow'])) ? sizeof($this->_tpldata['topicrow']) : 0;if ($_topicrow_count) {for ($_topicrow_i = 0; $_topicrow_i < $_topicrow_count; ++$_topicrow_i){$_topicrow_val = &$this->_tpldata['topicrow'][$_topicrow_i]; ?>
		...
		<tr class="efekt">
			...
			<?php if ($this->_rootref['S_TOPIC_ICONS']) {  ?>
				...
				<td class="row2" width="25" align="center"><?php if ($_topicrow_val['TOPIC_ICON_IMG']) {  ?><img src="<?php echo (isset($this->_rootref['T_ICONS_PATH'])) ? $this->_rootref['T_ICONS_PATH'] : ''; echo $_topicrow_val['TOPIC_ICON_IMG']; ?>" width="<?php echo $_topicrow_val['TOPIC_ICON_IMG_WIDTH']; ?>" height="<?php echo $_topicrow_val['TOPIC_ICON_IMG_HEIGHT']; ?>" alt="" title="" /></td><?php } } ?>
			...
			<td class="row2">
				...
				<p class="gensmall"><?php echo ((isset($this->_rootref['L_AUTHOR'])) ? $this->_rootref['L_AUTHOR'] : ((isset($user->lang['AUTHOR'])) ? $user->lang['AUTHOR'] : '{ AUTHOR }')); ?>: <?php echo $_topicrow_val['TOPIC_AUTHOR_FULL']; ?></p>
			</td>
			<td class="row2" width="50" align="center"><p class="topicdetails"><?php echo $_topicrow_val['REPLIES']; ?></p></td>
			...
			<td class="row2" width="140" align="center">
				...
				<p class="topicdetails"><?php echo $_topicrow_val['LAST_POST_AUTHOR_FULL']; ?>
					...
					<?php if (! $this->_rootref['S_IS_BOT']) {  ?><a href="<?php echo $_topicrow_val['U_LAST_POST']; ?>" class="minipostimg"><?php echo (isset($this->_rootref['LAST_POST_IMG'])) ? $this->_rootref['LAST_POST_IMG'] : ''; ?></a><?php } ?>
	...
	<?php }} else { ?>
		...
		<tr>
			...
			<?php } else { ?>
				...
				<td class="row1" colspan="5" height="30" align="center" valign="middle"><span class="gen"><?php if (! $this->_rootref['S_SORT_DAYS']) {  echo ((isset($this->_rootref['L_NO_TOPICS'])) ? $this->_rootref['L_NO_TOPICS'] : ((isset($user->lang['NO_TOPICS'])) ? $user->lang['NO_TOPICS'] : '{ NO_TOPICS }')); } else { echo ((isset($this->_rootref['L_NO_TOPICS_TIME_FRAME'])) ? $this->_rootref['L_NO_TOPICS_TIME_FRAME'] : ((isset($user->lang['NO_TOPICS_TIME_FRAME'])) ? $user->lang['NO_TOPICS_TIME_FRAME'] : '{ NO_TOPICS_TIME_FRAME }')); } ?></span></td>
			<?php } ?>
	...
	<tr align="center">
		<td class="cat" colspan="<?php if ($this->_rootref['S_TOPIC_ICONS']) {  ?>6<?php } else { ?>5<?php } ?>">&nbsp;</td>
	</tr>
	</table>
...
<?php } if ($this->_rootref['S_DISPLAY_POST_INFO'] || $this->_rootref['TOTAL_TOPICS']) {  ?>
	...
	<?php } if (! $this->_rootref['S_DISPLAY_ACTIVE'] && ( $this->_rootref['S_IS_POSTABLE'] || sizeof($this->_tpldata['topicrow']) )) {  ?>
		...
		<table class="tablebg" width="100%" cellspacing="1">
		<tr>
			<td class="cat" colspan="<?php if ($this->_rootref['S_TOPIC_ICONS']) {  ?>6<?php } else { ?>5<?php } ?>">
		...
		<?php $_topicrow_count = (isset($this->_tpldata['topicrow'])) ? sizeof($this->_tpldata['topicrow']) : 0;if ($_topicrow_count) {for ($_topicrow_i = 0; $_topicrow_i < $_topicrow_count; ++$_topicrow_i){$_topicrow_val = &$this->_tpldata['topicrow'][$_topicrow_i]; if ($_topicrow_val['S_TOPIC_TYPE_SWITCH'] == (1)) {  ?>
				...
				<tr>
					<td class="row1" colspan="<?php if ($this->_rootref['S_TOPIC_ICONS']) {  ?>6<?php } else { ?>5<?php } ?>"><b class="gensmall"><?php echo ((isset($this->_rootref['L_ANNOUNCEMENTS'])) ? $this->_rootref['L_ANNOUNCEMENTS'] : ((isset($user->lang['ANNOUNCEMENTS'])) ? $user->lang['ANNOUNCEMENTS'] : '{ ANNOUNCEMENTS }')); ?></b></td>
				</tr>
			<?php } else if ($_topicrow_val['S_TOPIC_TYPE_SWITCH'] == 0) {  ?>

				<tr>
					<td class="row1" colspan="<?php if ($this->_rootref['S_TOPIC_ICONS']) {  ?>6<?php } else { ?>5<?php } ?>"><b class="gensmall"><?php echo ((isset($this->_rootref['L_TOPICS'])) ? $this->_rootref['L_TOPICS'] : ((isset($user->lang['TOPICS'])) ? $user->lang['TOPICS'] : '{ TOPICS }')); ?></b></td>
				</tr>
			<?php } ?>
			...
			<tr class="efekt">
				...
				<?php if ($this->_rootref['S_TOPIC_ICONS']) {  ?>
					...
					<td class="row2" width="25" align="center"><?php if ($_topicrow_val['TOPIC_ICON_IMG']) {  ?><img src="<?php echo (isset($this->_rootref['T_ICONS_PATH'])) ? $this->_rootref['T_ICONS_PATH'] : ''; echo $_topicrow_val['TOPIC_ICON_IMG']; ?>" width="<?php echo $_topicrow_val['TOPIC_ICON_IMG_WIDTH']; ?>" height="<?php echo $_topicrow_val['TOPIC_ICON_IMG_HEIGHT']; ?>" alt="" title="" /><?php } ?></td>
				<?php } ?>
				...
				<td class="row2" width="140" align="center">
					...
					<p class="topicdetails"><?php echo $_topicrow_val['LAST_POST_AUTHOR_FULL']; ?>
						...
						<?php if (! $this->_rootref['S_IS_BOT']) {  ?><a href="<?php echo $_topicrow_val['U_LAST_POST']; ?>" class="lastpost"><?php echo (isset($this->_rootref['LAST_POST_IMG'])) ? $this->_rootref['LAST_POST_IMG'] : ''; ?></a><?php } ?>
...
<h4 class="notable"><?php echo ((isset($this->_rootref['L_WHO_IS_ONLINE'])) ? $this->_rootref['L_WHO_IS_ONLINE'] : ((isset($user->lang['WHO_IS_ONLINE'])) ? $user->lang['WHO_IS_ONLINE'] : '{ WHO_IS_ONLINE }')); ?></h4>
<p class="notable"><?php echo (isset($this->_rootref['LOGGED_IN_USER_LIST'])) ? $this->_rootref['LOGGED_IN_USER_LIST'] : ''; ?></p>
<?php } if ($this->_rootref['S_DISPLAY_POST_INFO']) {  ?>

<h4 class="notable"><?php echo ((isset($this->_rootref['L_FORUM_PERMISSIONS'])) ? $this->_rootref['L_FORUM_PERMISSIONS'] : ((isset($user->lang['FORUM_PERMISSIONS'])) ? $user->lang['FORUM_PERMISSIONS'] : '{ FORUM_PERMISSIONS }')); ?></h4>
