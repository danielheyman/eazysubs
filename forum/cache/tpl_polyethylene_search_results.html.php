...
<?php if ($this->_rootref['S_SHOW_TOPICS']) {  ?>
	...
	<tr>
		<th colspan="3" nowrap="nowrap">&nbsp;<?php echo ((isset($this->_rootref['L_TOPICS'])) ? $this->_rootref['L_TOPICS'] : ((isset($user->lang['TOPICS'])) ? $user->lang['TOPICS'] : '{ TOPICS }')); ?>&nbsp;</th>
		...
		<th nowrap="nowrap">&nbsp;<?php echo ((isset($this->_rootref['L_REPLIES'])) ? $this->_rootref['L_REPLIES'] : ((isset($user->lang['REPLIES'])) ? $user->lang['REPLIES'] : '{ REPLIES }')); ?>&nbsp;/&nbsp;<?php echo ((isset($this->_rootref['L_VIEWS'])) ? $this->_rootref['L_VIEWS'] : ((isset($user->lang['VIEWS'])) ? $user->lang['VIEWS'] : '{ VIEWS }')); ?>&nbsp;</th>
	...
	<?php $_searchresults_count = (isset($this->_tpldata['searchresults'])) ? sizeof($this->_tpldata['searchresults']) : 0;if ($_searchresults_count) {for ($_searchresults_i = 0; $_searchresults_i < $_searchresults_count; ++$_searchresults_i){$_searchresults_val = &$this->_tpldata['searchresults'][$_searchresults_i]; ?>
		...
		<tr valign="middle" class="efekt">
			...
			<td class="row1" width="50" align="center"><p class="topicdetails"><?php echo $_searchresults_val['TOPIC_REPLIES']; ?> / <?php echo $_searchresults_val['TOPIC_VIEWS']; ?></p></td>
	...
	<?php }} else { ?>
		...
		<tr valign="middle">
			<td colspan="7" class="row1" align="center"><?php echo ((isset($this->_rootref['L_NO_SEARCH_RESULTS'])) ? $this->_rootref['L_NO_SEARCH_RESULTS'] : ((isset($user->lang['NO_SEARCH_RESULTS'])) ? $user->lang['NO_SEARCH_RESULTS'] : '{ NO_SEARCH_RESULTS }')); ?></td>
		</tr>
	<?php } ?>
...
<?php } else { ?>
	...
	<?php }} else { ?>
		...
		<tr valign="middle">
			<td colspan="2" class="row1" align="center"><?php echo ((isset($this->_rootref['L_NO_SEARCH_RESULTS'])) ? $this->_rootref['L_NO_SEARCH_RESULTS'] : ((isset($user->lang['NO_SEARCH_RESULTS'])) ? $user->lang['NO_SEARCH_RESULTS'] : '{ NO_SEARCH_RESULTS }')); ?></td>
		</tr>
	<?php } ?>
