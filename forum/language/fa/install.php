...
',
	...
	'INSTALL_CONGRATS_EXPLAIN'	=> '
		...
		<p>با كليك روي دكمه زير به مركز مديريت هدايت خواهيد شد. شما مي توانيد <a href="http://www.phpbb.maghsad.com"> پشتیبان رسمی phpBB فارسی</a> ، <a href="http://index.maghsad.com/phpbb-learning/phpbb-3-t3686.html">کتاب راهنمای جامع تصویری phpBB به زبان فارسی </a> ، <a href="http://index.maghsad.com/phpbb-farsi/"> انجمن های پشتیبانی phpBB فارسی ، </a> ، <a href="http://www.phpBB.com"> سایت رسمی phpBB به زبان انگلیسی </a> و <a href="%3$s">فايل مرا بخوان</a> با كليك روي هر گزينه استفاده كنيد. <br /><br />لطفا همين الان پوشه install را پاك كنيد. در غير اين صورت فقط منوي مديكر كل قابل دسترسي خواهد بود و انجمن شما تا پاك شدن پوشه ر غير فعال باقي مي ماند.
</strong></p>
',
...
$lang = array_merge($lang, array(
	...
	'CONFIG_SITE_DESC'				=> 'ساخته شده توسط phpBB آسان نصب مقصد',
	'CONFIG_SITENAME'				=> 'phpBB.Maghsad.com',

	'DEFAULT_INSTALL_POST'			=> 'این پست صرفا یک نمونه پست است. 
برای ادامه کار با انجمن خود می توانید این انجمن نمونه و این پست را پاک کرده یا تغییر دهید.
 برای اطلاعات بیشتر در باره نحوه استفاده به <a href="http://phpBB.Maghsad.com">www.phpBB.Maghsad.com</a> مراجعه فرمایید.
همچنین می توانید برای استفاده از سایر خدمات مقصد، و همچنین هاست رایگان به نشانی <a href="http://www.Maghsad.com">www.Maghsad.com</a> مراجعه فرمایید.',
