...
$lang = array_merge($lang, array(
	...
	'NEW_MEMBER_POST_LIMIT_EXPLAIN'		=> 'Зноў зарэгістраваныя карыстальнікі будуць знаходзіцца ў групе «Новыя карыстальнікі», пакуль яны не апублікуюць названай тут колькасці паведамленняў. Вы можаце выкарыстоўваць гэтую групу, каб перашкодзіць новым карыстальнікам выкарыстоўваць сістэму асабістых паведамленняў, або для папярэдняга прагляду іх паведамленняў. Увядзіце 0, калі жадаеце адключыць гэтую магчымасць.',
...
$lang = array_merge($lang, array(
	'ACP_VC_SETTINGS_EXPLAIN'				=> 'Тут вы можаце выбраць і настроіць анты-спам модулі, якія рэалізуюць розныя спосабы прадухілення аўтаматызаваных рэгістрацый.',
	...
	'CAPTCHA_PREVIEW_MSG'					=> 'Змены ў настройках візуальнага пацверджання яшчэ не былі захаваныя. Гэта проста папярэдні прагляд.',
...
$lang = array_merge($lang, array(
	...
	'MAX_LOGIN_ATTEMPTS_EXPLAIN'	=> 'Пасля паказанай колькасці няўдалых спроб уваходу на канферэнцыю карыстальнік павінен будзе дадаткова прайсці анты-спам тэст.',
	'NO_IP_VALIDATION'				=> 'Не',
