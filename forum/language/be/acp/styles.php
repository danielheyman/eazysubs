...
$lang = array_merge($lang, array(
	...
	'AUTOMATIC_EXPLAIN'		=> 'Пакіньце поле пустым для аўтаматычнага вызначэння.',
	...
	'CACHE'							=> 'Кэш',
	'CACHE_CACHED'					=> 'Дата кэшаваньня',
	'CACHE_FILENAME'				=> 'Файл шаблону',
	'CACHE_FILESIZE'				=> 'Памер файла',
	'CACHE_MODIFIED'				=> 'Дата змены',
	...
	'DELETE_IMAGESET_EXPLAIN'	=> 'Тут вы можаце выдаліць з базы дадзеных вылучаны набор малюнкаў. Калі ласка, улічыце, што адмяніць выдаленне немагчыма. Выдаленне набору малюнкаў адбываецца беззваротна. Рэкамендуецца спачатку экспартаваць набор малюнкаў для магчымага выкарыстання ў будучыні.',
	...
	'DELETE_TEMPLATE_EXPLAIN'	=> 'Тут вы можаце выдаліць з базы дадзеных вылучаны шаблон. Калі ласка, улічыце, што адмяніць выдаленне немагчыма. Выдаленне шаблонаў адбываецца беззваротна. Рэкамендуецца спачатку экспартаваць шаблон для магчымага выкарыстання ў будучыні.',
	'DELETE_THEME'				=> 'Выдаліць тэму',
	'DELETE_THEME_EXPLAIN'		=> 'Тут вы можаце выдаліць з базы дадзеных вылучаную тэму. Калі ласка, улічыце, што адмяніць выдаленне немагчыма. Выдаленне тэм адбываецца беззваротна. Рэкамендуецца спачатку экспартаваць тэму для магчымага выкарыстання ў будучыні.',
	'DETAILS'					=> 'Інфармацыя',
	...
	'IMG_FORUM_UNREAD'			=> 'Форум з непрачытанымі паведамленнямі',
	'IMG_FORUM_UNREAD_LOCKED'	=> 'Зачынены форум з непрачытанымі паведамленнямі',
	'IMG_FORUM_UNREAD_SUBFORUM'	=> 'Падфорум з непрачытанымі паведамленнямі',
	'IMG_SUBFORUM_READ'			=> 'Легенда падфорума',
	'IMG_SUBFORUM_UNREAD'		=> 'Легенда падфорума з новымі паведамленнямі',

	'IMG_TOPIC_MOVED'			=> 'Перамешчаная тэма',

	'IMG_TOPIC_READ'				=> 'Тэма',
	'IMG_TOPIC_READ_MINE'			=> 'Тэма з маімі паведамленнямі',
	'IMG_TOPIC_READ_HOT'			=> 'Папулярная тэма',
	'IMG_TOPIC_READ_HOT_MINE'		=> 'Папулярная тэма з маімі паведамленнямі',
	'IMG_TOPIC_READ_LOCKED'			=> 'Зачыненая тэма',
	'IMG_TOPIC_READ_LOCKED_MINE'	=> 'Зачыненая тэма з маімі паведамленнямі',

	'IMG_TOPIC_UNREAD'				=> 'Тэма з непрачытанымі паведамленнямі',
	'IMG_TOPIC_UNREAD_MINE'			=> 'Тэма з непрачытанымі паведамленнямі, якая змяшчае мае паведамленні',
	'IMG_TOPIC_UNREAD_HOT'			=> 'Папулярная тэма з непрачытанымі паведамленнямі',
	'IMG_TOPIC_UNREAD_HOT_MINE'		=> 'Папулярная тэма з непрачытанымі паведамленнямі, якая змяшчае мае паведамленні',
	'IMG_TOPIC_UNREAD_LOCKED'		=> 'Зачыненая тэма з непрачытанымі паведамленнямі',
	'IMG_TOPIC_UNREAD_LOCKED_MINE'	=> 'Зачыненая тэма з непрачытанымі паведамленнямі, якая змяшчае мае паведамленні',

	'IMG_STICKY_READ'				=> 'Прымацаваная тэма',
	'IMG_STICKY_READ_MINE'			=> 'Прымацаваная тэма з маімі паведамленнямі',
	'IMG_STICKY_READ_LOCKED'		=> 'Зачыненая прымацаваная тэма',
	'IMG_STICKY_READ_LOCKED_MINE'	=> 'Зачыненая прымацаваная тэма з маімі паведамленнямі',
	'IMG_STICKY_UNREAD'				=> 'Прымацаваная тэма з непрачытанымі паведамленнямі',
	'IMG_STICKY_UNREAD_MINE'		=> 'Прымацаваная тэма з маімі непрачытанымі паведамленнямі',
	'IMG_STICKY_UNREAD_LOCKED'		=> 'Зачыненая прымацаваная тэма з непрачытанымі паведамленнямі',
	'IMG_STICKY_UNREAD_LOCKED_MINE'	=> 'Зачыненая прымацаваная тэма з маімі непрачытанымі паведамленнямі',
	...
	'IMG_ANNOUNCE_UNREAD'				=> 'Аб\'ява з непрачытанымі паведамленнямі',
	'IMG_ANNOUNCE_UNREAD_MINE'			=> 'Аб\'ява з непрачытанымі паведамленнямі, якая змяшчае мае паведамленні',
	'IMG_ANNOUNCE_UNREAD_LOCKED'		=> 'Зачыненая аб\'ява з непрачытанымі паведамленнямі',
	'IMG_ANNOUNCE_UNREAD_LOCKED_MINE'	=> 'Зачыненая аб\'ява з непрачытанымі паведамленнямі, якая змяшчае мае паведамленні',
	...
	'IMG_GLOBAL_UNREAD'					=> 'Агульная тэма з непрачытанымі паведамленнямі',
	'IMG_GLOBAL_UNREAD_MINE'			=> 'Агульная тэма з непрачытанымі паведамленнямі, якая змяшчае мае паведамленні',
	'IMG_GLOBAL_UNREAD_LOCKED'			=> 'Зачыненая агульная тэма з непрачытанымі паведамленнямі',
	'IMG_GLOBAL_UNREAD_LOCKED_MINE'		=> 'Зачыненая агульная тэма з непрачытанымі паведамленнямі, якая змяшчае мае паведамленні',
	...
	'IMG_ICON_CONTACT_EMAIL'	=> 'Адправіць электроннае паведамленне',
	'IMG_ICON_CONTACT_ICQ'		=> 'ICQ',
	'IMG_ICON_CONTACT_JABBER'	=> 'Jabber',
	'IMG_ICON_CONTACT_MSNM'		=> 'MSNM',
	'IMG_ICON_CONTACT_PM'		=> 'Адаслаць асабістае паведамленне',
	...
	'STYLE_DETAILS_UPDATED'		=> 'Стыль паспяхова зменены.',
	'STYLE_ERR_ARCHIVE'			=> 'Выберыце метад архівавання.',
	'STYLE_ERR_COPY_LONG'		=> 'Даўжыня капірайту не можа быць больш 60 знакаў.',
	'STYLE_ERR_MORE_ELEMENTS'	=> 'Неабходна выбраць хаця б адзін элемент стылю.',
	...
	'STYLE_ERR_NO_IDS'			=> 'Неабходна выбраць шаблон, тэму і пакет малюнкаў для гэтага стылю.',
	...
	'STYLE_EXPORTED'			=> 'Стыль паспяхова экспартаваны і захаваны ў тэчцы %s.',
	'STYLE_IMAGESET'			=> 'Набор малюнкаў',
	'STYLE_NAME'				=> 'Імя стылю',
	'STYLE_TEMPLATE'			=> 'Шаблон',
	'STYLE_THEME'				=> 'Тэма',
	'STYLE_USED_BY'				=> 'Выкарыстоўваюць (з ботами)',
	...
	'TEMPLATE_ERR_STYLE_NAME'	=> 'Неабходна задаць імя для гэтага шаблону.',
	...
	'TEMPLATE_FILE_NOT_WRITABLE'=> 'Не атрымалася запісаць файл шаблону %s. Калі ласка, праверце права на папкі і файлы.',
	...
	'THEME_ERR_NAME_LONG'		=> 'Імя тэмы не павінна перавышаць 30 сімвалаў.',
