...
$lang = array_merge($lang, array(
	...
	'DB_HOST_EXPLAIN'			=> 'DSN - імя крыніцы дадзеных пры ўсталёўцы з выкарыстаннем ODBC. Для PostgreSQL выкарыстайце лакальнае падключэнне да лакальнага сервера праз UNIX сокет і 127.0.0.1 для падлучэння праз TCP.',
	...
	'DB_UPDATE_NOT_SUPPORTED'	=> 'Нажаль, дадзены сцэнар не падтрымлівае абнаўленне з версій phpBB да «%1$s». Усталяваная вамі версія — «%2$s». Абнавіце папярэднюю версію перад выкананнем гэтага сцэнара. Дапамогу па гэтай праблеме можна знайсці на форумах падтрымкі на бачыне phpBB.com.',
	...
	'DLL_MSSQLNATIVE'			=> 'MSSQL Server 2005+ [ Родны ]',
	'DLL_MYSQL'					=> 'MySQL',
	...
	'FIREBIRD_DBMS_UPDATE_REQUIRED'		=> 'phpBB больш не падтрымлівае Firebird/Interbase да версіі 2.1. Перад працягам працэсу абнаўлення абновіце Firebird, прынамсі, да версіі 2.1.0.',
	...
	<ul>
		...
		<li>MS SQL Server 2005 і вышэй (родны)</li>
		<li>Oracle</li>
	</ul>
...
$lang = array_merge($lang, array(
	...
	'UPGRADE_INSTRUCTIONS'			=> 'Даступна новая версія <strong>%1$s</strong>. Калі ласка, прачытайце <a href="%2$s" title="%2$s"><strong>аб\'яву аб выпуску</strong></a>, каб даведацца пра тое, што яна можа прапанаваць, і як абнавіць.',
