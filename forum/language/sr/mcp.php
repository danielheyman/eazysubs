...
$lang = array_merge($lang, array(
	...
	'CLOSE_PM_REPORT'		=> 'Затвори пријаву приватне поруке',
	'CLOSE_PM_REPORT_CONFIRM'	=> 'Да ли сигурно желите да затворите одабрану пријаву приватне поруке?',
	'CLOSE_PM_REPORTS'		=> 'Затвори пријаве приватних порука',
	'CLOSE_PM_REPORTS_CONFIRM'	=> 'Да ли сигурно желите да затворите одабране пријаве приватних порука?',
	...
	'DELETE_PM_REPORT'			=> 'Обриши пријаву приватне поруке',
	'DELETE_PM_REPORT_CONFIRM'	=> 'Да ли сигурно желите да обришете одабрану пријаву приватне поруке?',
	'DELETE_PM_REPORTS'			=> 'Обриши пријаве приватних порука',
	'DELETE_PM_REPORTS_CONFIRM'	=> 'Да ли сигурно желите да обришете одабране пријаве приватних порука?',
	...
	'LATEST_REPORTED_PMS'		=> 'Последњих 5 пријава приватних порука',
	...
	'MCP_PM_REPORTS'				=> 'Пријављене приватне поруке',
	'MCP_PM_REPORT_DETAILS'			=> 'Појединости пријаве приватне поруке',
	'MCP_PM_REPORTS_CLOSED'			=> 'Затворене пријаве приватне поруке',
	'MCP_PM_REPORTS_CLOSED_EXPLAIN'	=> 'Ово је списак свих пријава приватних порука које су претходно решене.',
	'MCP_PM_REPORTS_OPEN'			=> 'Отвори пријаву приватне поруке',
	...
	'PM_REPORT_CLOSED_SUCCESS'	=> 'Одабрана пријава приватне поруке је успешно затворена.',
	'PM_REPORT_DELETED_SUCCESS'	=> 'Одабрана пријава приватне поруке је успешно обрисана.',
	'PM_REPORTED_SUCCESS'		=> 'Ова приватна порука је успешно пријављена.',
	'PM_REPORT_TOTAL'			=> 'Укупно има <strong>1</strong> пријава приватне поруке за преглед.',
	'PM_REPORTS_CLOSED_SUCCESS'	=> 'Одабране пријаве приватних порука су успешно затворене.',
	'PM_REPORTS_DELETED_SUCCESS'=> 'Одабране пријаве приватних порука су успешно обрисане.',
	'PM_REPORTS_TOTAL'			=> 'Укупно има <strong>%d</strong> пријава приватних порука за преглед.',
	'PM_REPORTS_ZERO_TOTAL'		=> 'Нема пријава приватних порука за преглед.',
	...
	'TOPIC_RESYNC_SUCCESS'		=> 'Одабрана тема је ресихронизована.',
