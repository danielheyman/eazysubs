...
$help = array(
	...
	array(
		...
		1 => 'Só os usuarios rexistrados poden enviar correo-e a outros usuarios a través do formulario integrado, e só se o administrador habilitou esa posibilidade. Isto faise para previr o uso malintencionado do sistema de correo-e por parte de usuarios anónimos.'
	),
	array(
		0 => '--',
	...
	array(
		...
		1 => 'Se o administrador do taboleiro habilitou a opción correspondente, poderás ver un botón para enviar informes de mensaxes a carón da mensaxe da que queres informar. Premendo nel, serás guiado a través dos chanzos precisos para emitir o informe verbo da mensaxe.'
	),
	array(
		0 => 'Para que serve o botón “Gardar” que aparece na publicación de temas?',
		1 => 'Isto permitirache gardar anacos que queiras completar e enviar posteriormente. Para recargar un anaco gardado, visita o Panel de Control de Usuario.'
	),
	array(
	...
	array(
		...
		1 => 'Si, pódense amosar imaxes nas túas mensaxes publicadas. Se o administrador habilitou a posibilidade de engadir adxuntos, pode que esteas autorizado a subir a imaxe ao taboleiro. Caso contrario, deberás ligar a unha imaxe almacenada nun servidor web accesíbel publicamente, é dicir, http://www.exemplo.com/a-minha-imaxe.gif. Non podes ligar a imaxes gardadas no teu propio PC (a menos que sexa un servidor accesíbel publicamente) nin a imaxes gardadas tras mecanismos de identificación como as caixas de correo de Hotmail ou Yahoo, sitios protexidos por contrasinal etc. Para amosar unha imaxe utiliza a etiqueta [img] do BBCode.'
	),
	array(
	...
	array(
		...
		1 => 'Esta páxina ofréceche unha lista do persoal que administra o taboleiro, incluíndo os administradores do mesmo e os moderadores canda outros pormenores coma os foros que moderan.'
	),
	array(
		0 => '--',
	...
	array(
		...
		1 => 'Hai tres posíbeis razóns: Non estás rexistrado ou non iniciaches a sesión, o administrador desactivou o sistema de mensaxes privadas para todo o foro ou o administrador desactivou para ti individualmente a mensaxería privada. Contacta con algún administrador do taboleiro para obter máis información.'
	),
	array(
	...
	array(
		...
		1 => 'Insire un termo de procura na caixa de busca ubicada no índice, foro ou páxinas de temas. Podes acceder á procura avanzada premendo na ligazón “Procura Avanzada” dispoñíbel en todas as páxinas do foro. O procedemento de acceso á procura pode depender do estilo utilizado.'
	),
	array(
		0 => 'Por que a miña procura non amosa resultados?',
		1 => 'Pode que a túa procura fose indefinida de máis e incluíse varios termos comúns que o phpBB3 non indexa. Tenta ser máis específico e utiliza as opcións dispoñíbeis na Procura avanzada.'
	),
	array(
		0 => 'Por que a miña procura amosa unha páxina en branco!?',
		1 => 'A túa procura devolveu demasiados resultados e o servidor web non puido xestionalos. Utiliza a “Procura avanzada” e mira de ser máis específico cos termos inseridos e os foros nos que queres buscar.'
	),
	array(
	...
	array(
		...
		1 => 'Podes acceder ás túas mensaxes publicadas ben premendo na ligazón “Procurar mensaxes publicadas por un usuario” no Panel de Control de Usuario ou ben a través da páxina do teu perfil. Para procurar os teus temas, utiliza a páxina de Procura avanzada e enche as diversas opcións como sexa preciso.'
	),
	array(
		0 => '--',
		1 => 'Subscricións a Temas e Favoritos'
	),
	array(
		0 => 'Cal é a diferenza entre marcar como favorito e subscribirse?',
		1 => 'Marcar como favorito no phpBB3 é moito máis que facelo no teu navegador web. Non serás avisado cando haxa unha actualización, pero poderás volver ao tema máis tarde. A subscrición, porén, notificarate cando haxa unha actualización no tema ou foro do taboleiro mediante o método ou métodos que prefiras.'
	),
	array(
	...
	array(
		...
		1 => 'Este foro foi escrito e licenciado a través do phpBB Group. Se cres que debería ter algunha outra opción ou característica visita phpbb.com e mira o que o phpBB Group ten que dicir. Non publiques mensaxes dese tipo nos foros de phpBB.com, xa que phpBB Group utiliza o Sourceforge para xestionar as tarefas de novas características. Recorre os foros e mira cal é, se a temos, a nosa postura concreta para determinadas características e logo segue o procedemento aquí descrito.'
	),
	array(
