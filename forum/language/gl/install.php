...
$lang = array_merge($lang, array(
	...
	'AVAILABLE_CONVERTORS'		=> 'Conversores dispoñíbeis',
	...
	'CACHE_STORE_EXPLAIN'		=> 'A ubicación física onde se gardará a caché de datos, preferibelmente no sistema de arquivos.',
	'CAT_CONVERT'				=> 'Converter',
	'CAT_INSTALL'				=> 'Instalar',
	'CAT_OVERVIEW'				=> 'Resumo',
	'CAT_UPDATE'				=> 'Actualización',
	'CHANGE'					=> 'Mudar',
	'CHECK_TABLE_PREFIX'		=> 'Comproba o prefixo da túa táboa e téntao de novo.',
	...
	'COLLIDING_USERNAMES_FOUND'	=> 'Atopáronse nomes de usuario en conflito no teu vello taboleiro. Para poder completar a conversión, elimina ou muda o nome deses usuarios, xa que só pode haber un usuario no teu taboleiro antigo para cada nome de usuario limpo.',
	...
	'CONFIG_PHPBB_EMPTY'		=> 'A variábel de configuración do phpBB3 para "%s" está baleira.',
	...
	'CONVERT_COMPLETE_EXPLAIN'	=> 'Conseguiches converter o teu foro a phpBB 3.0. Agora xa podes iniciar sesión e <a href="../">acceder ao teu foro</a>. Asegúrate de que a configuración foi transferida correctamente antes de activar o teu taboleiro eliminando o directorio de instalación. Lembra que a axuda en liña de uso de phpBB está dispoñíbel na <a href="http://www.phpbb.com/support/documentation/3.0/">Documentación</a> e no <a href="http://www.phpbb.com/phpBB/viewforum.php?f=46">foro de soporte</a>',
	...
	'CONV_ERR_FATAL'					=> 'Erro irrecuperábel de conversión',

	'CONV_ERROR_ATTACH_FTP_DIR'			=> 'Subida FTP de anexos está activada no taboleiro vello. Copia todos os ficheiros Anexos a un directorio accesíbel, desactiva a subida por ftp e asegúrate de que un directorio de subidas válido estea especificado. Se o fixeches, reinicia o conversor.',
	...
	'CONV_ERROR_GROUP_ACCESS'			=> 'Imposíbel obter información da autenticación do grupo.',
	...
	'CONV_ERROR_INSERT_USER_GROUP'		=> 'Imposíbel inserir usuario na táboa user_group.',
	...
	'CONV_ERROR_NO_FORUM_PATH'			=> 'A ruta relativa ao foro fonte non foi especificada.',
	...
	'CONV_ERROR_NO_RANKS_PATH'			=> 'Nota para o programador: debes especificar $convertor[\'ruta_rangos\'] para empregar %s.',
	'CONV_ERROR_NO_SMILIES_PATH'		=> 'Nota para o programador: debes especificar $convertor[\'ruta_risoños\'] para empregar %s.',
	'CONV_ERROR_NO_UPLOAD_DIR'			=> 'Nota para o programador: debes especificar $convertor[\'directorio_subida\'] para empregar %s.',
	'CONV_ERROR_PERM_SETTING'			=> 'Imposíbel inserir/actualizar configuración de permisos.',
	'CONV_ERROR_PM_COUNT'				=> 'Non se puido seleccionar o cartafol de reconto pm',
	...
	'CONV_ERROR_USER_ACCESS'			=> 'Imposíbel obter a información de autenticación do usuario',
	...
	'COULD_NOT_COPY'			=> 'Non se puido copiar o ficheiro <strong>%1$s</strong> a <strong>%2$s</strong><br /><br />Verifica que o directorio de destino existe e que pode ser escrito polo servidor web.',
	'COULD_NOT_FIND_PATH'		=> 'Non se puido atopar a ruta ao teu antigo foro. Verifica as túas configuracións e téntao de novo.<br />» A ruta fonte especificada era %s',
	...
	'DB_UPDATE_NOT_SUPPORTED'	=> 'Sentímolo, pero este script non permite a actualización desde versións anteriores á “%1$s”. A versión que tes actualmente instalada é a “%2$s”. Actualiza a unha versión previa antes de executares este script. De precisares axuda con isto podes acudir ao Foro de Soporte de phpBB.com.',
	...
	'FIREBIRD_DBMS_UPDATE_REQUIRED'		=> 'O phpBB xa non admite Firebird/Interbase anteriores á versión 2.1. Actualiza a túa instalación do Firebird á versión 2.1.0, como mínimo, antes de procederes coa actualización.',

	'FINAL_STEP'				=> 'Procesar o último paso',
	...
	'INITIAL_CONFIG_EXPLAIN'	=> 'Agora que a instalación determinou que o phpBB pode funcionar no teu servidor, é preciso que proporciones certa información específica. Se non sabes como conectar coa túa base de datos, por favor contacta co teu provedor de aloxamento (preferibelmente) ou usa os foros de soporte de phpBB. Ao introducir a información, por favor asegúrate de comprobala polo miúdo antes de continuar.',
...
// TODO: write some more introductions here
	...
	'INSTALL_SEND_CONFIG'		=> 'Por desgraza o phpBB non puido escribir a información de configuración directamente ao teu config.php. Pode ser porque o arquivo non exista ou non teñas permisos de escritura. Listaranse de seguido unha serie de opcións que che permitirán completar a instalación do config.php.',
	...
	'INST_ERR_DB_FORUM_PATH'	=> 'A base de datos especificada está dentro da árbore directorio dos teus foros.  Deberías poñer este ficheiro nunha localización non accesíbel desde a web.',
	'INST_ERR_DB_NO_ERROR'		=> 'Non se recibiu mensaxe de erro ningunha',
	'INST_ERR_DB_NO_MYSQLI'		=> 'A versión instalada de MySQL é incompatíbel coa opción "MySQL with MySQLi Extension" que escolliches. Tenta coa opción "MySQL" no seu lugar.',
	'INST_ERR_DB_NO_SQLITE'		=> 'A versión do SQLite instalada é demasiado vella, debe estar actualizada coma mínimo á versión 2.8.2',
	...
	'INST_ERR_DB_NO_FIREBIRD'	=> 'A versión do FireBird instalado neste equipo é anterior á versión 2.1, actualízao á versión máis recente.',
	...
	'INST_ERR_DB_NO_POSTGRES'	=> 'A base de datos que escolliches non foi creada cunha codificación <var>UNICODE</var> ou <var>UTF8</var>. Proba a instalación cunha base de datos con codificación <var>UNICODE</var> ou <var>UTF8</var>',
	...
	'INST_ERR_FATAL_DB'			=> 'Erro fatal e irrecuperábel na base de datos. Isto pode ser porque o usuario non ten dereitos para crear táboas ou inserir datos etc. Debaixo podes ter máis información. Contacta co teu provedor de servizos ou visita os foros de apoio de phpBB para máis axuda. ',
	...
	'INST_ERR_PREFIX_INVALID'	=> 'O prefixo de táboa que especificaches non é válido para a túa base de datos. Téntao con outro prefixo e elimina caracteres tales coma guións, subliñados etc.',
	...
	'MBSTRING_CHECK_EXPLAIN'				=> 'A <samp>mbstring</samp> é unha extensión PHP que proporciona funcións de cadeas multibyte. Algunhas características da mbstring non son compatíbeis co phpBB e deben desactivarse.',
	...
	'PHP_GETIMAGESIZE_SUPPORT'			=> 'A función do PHP getimagesize() está dispoñíbel',
	'PHP_GETIMAGESIZE_SUPPORT_EXPLAIN'	=> '<strong>Requirido</strong> - Para que o phpBB funcione correctamente, é preciso que a función getimagesize estea dispoñíbel.',
	...
	'PHP_SUPPORTED_DB_EXPLAIN'		=> '<strong>Requirido</strong> - Debes ter soporte cando menos para una base de datos compatíbel con PHP. Se non aparece como dispoñíbel módulo ningún da base de datos, deberás contactar co teu provedor de aloxamento (hosting) ou revisar a documentación de instalación de PHP axeitada para obter consello.',
	'PHP_REGISTER_GLOBALS'			=> 'A opción de "register_globals" do PHP está desactivada',
	'PHP_REGISTER_GLOBALS_EXPLAIN'	=> 'O phpBB funcionará mesmo cando esta opción estea activada, mais, de ser posíbel, recoméndase que register_globals sexa desactivada na túa instalación de PHP por motivos de seguridade.',
	'PHP_SAFE_MODE'					=> 'Modo Seguro',
	'PHP_SETTINGS'					=> 'Versión e Configuración do PHP',
	'PHP_SETTINGS_EXPLAIN'			=> '<strong>Requirido</strong> - Debe estar funcionando polo menos a versión 4.3.3 de PHP para poder instalar phpBB. Se "safe mode" (modo seguro) aparece baixo a túa instalación de PHP, está funcionando nese modo. Isto imporá limitacións á administración remota e funcións semellantes.',
	...
	'PRE_CONVERT_COMPLETE'			=> 'Completáronse correctamente todos os pasos da pre-conversión. Agora podes comezar co proceso de conversión actual.',
	'PROCESS_LAST'					=> 'Procesando últimas declaracións',

	'REFRESH_PAGE'				=> 'Actualizar páxina para seguir coa conversión',
	'REFRESH_PAGE_EXPLAIN'		=> 'Se escolles SI, o conversor actualizará a páxina para continuar coa conversión logo de ter rematado un paso da mesma. Se é a túa primeira conversión co obxectivo de facer comprobacións e determinar posíbeis erros como paso previo, recomendámosche que escollas NON.',
	'REQUIREMENTS_TITLE'		=> 'Compatibilidade da Instalación',
	'REQUIREMENTS_EXPLAIN'		=> 'Antes de proceder coa instalación completa, phpBB fará diversos tests a configuración e ficheiros do teu servidor para asegurar que é posíbel instalar é executar phpBB. Asegúrate de ler polo miúdo os resultados e de non continuar até que todos os test sexan aprobados. Se queres habilitar algunha das funcionalidades listadas polos tests opcionais, deberías asegurarte de que eses tests tamén son aprobados.',
	'RETRY_WRITE'				=> 'Tentar de novo escribir a configuración',
	'RETRY_WRITE_EXPLAIN'		=> 'Se o desexas podes cambiar os permisos do config.php para permitir a phpBB escribir nel. Se é así, podes pulsar embaixo Retry (Intentar de novo) para probar outra vez. Recorda devolver os permisos iniciais ao config.php ao rematar a instalación.',
	...
	'UNABLE_WRITE_LOCK'			=> 'Imposíbel escribir nun arquivo pechado',
...
// Updater
$lang = array_merge($lang, array(
	'ALL_FILES_UP_TO_DATE'		=> 'Todos os arquivos están actualizados coa última versión do phpBB. Agora terás que <a href="../ucp.php?mode=login&amp;redirect=adm/index.php%3Fi=send_statistics%26mode=send_statistics">iniciar sesión no teu taboleiro</a> e comprobares se todo funciona de xeito correcto. Non esquezas eliminar, mudar de nome ou mover o teu directorio de instalación! Envíanos información actualizada acerca da configuración do teu servidor e taboleiro desde o módulo  <a href="../ucp.php?mode=login&amp;redirect=adm/index.php%3Fi=send_statistics%26mode=send_statistics">Enviar estatísticas</a> do teu PCA.',
	...
	'CHANGE_CLEAN_NAMES'			=> 'Mudouse o método empregado para asegurármonos de que un nome de usuario non é empregado por varios usuarios. Por iso, haberá algúns usuarios que terán o mesmo nomo ao ser comparados co novo método. Terás que eliminar ou mudar de nome os devanditos usuarios para estar certo de que cada nome é usado por un só usuario antes de que poidas proceder.',
	'CHECK_FILES'					=> 'Comprobar ficheiros',
	'CHECK_FILES_AGAIN'				=> 'Comprobar ficheiros novamente',
	'CHECK_FILES_EXPLAIN'			=> 'No seguinte paso todos os arquivos serán comprobados cos arquivos de actualización - isto pode levar un anaco se esta é a primeira comprobación de arquivos.',
	'CHECK_FILES_UP_TO_DATE'		=> 'De acordo coa base de datos a túa versión está actualizada. Podes comprobar os  arquivos para asegurar que todos os arquivos están realmente actualizados coa versión máis recente do phpBB.',
	'CHECK_UPDATE_DATABASE'			=> 'Seguir co proceso de actualización',
	'COLLECTED_INFORMATION'			=> 'Información sobre arquivos recollidos.',
	'COLLECTED_INFORMATION_EXPLAIN'	=> 'A seguinte lista mostra información sobre os arquivos que precisan unha actualización. Le a información fronte a cada bloque de estado para ver que significan e o que podes precisar para realizar unha actualización axeitada.',
	...
	'DATABASE_UPDATE_INFO_OLD'			=> 'O arquivo de actualización da base de datos, do directorio de instalación, está anticuado. Comprobe que cargou a versión correcta do arquivo.',
...
'DOWNLOAD_UPDATE_METHOD'			=> 'Descargar arquivo de ficheiros modificados',
	'DOWNLOAD_UPDATE_METHOD_EXPLAIN'	=> 'Unha vez descargado deberías desempaquetar o arquivo. Atoparás nel os ficheiros modificados que precisas cargar no teu directorio raíz pHPBB. Transfire daquela os ficheiros á súa respectiva localización. Despois de transferir todos os ficheiros, comproba de novo os ficheiros co botón de debaixo.',
	...
	'FILES_NEW_CONFLICT_EXPLAIN'	=> 'Estes son ficheiros novos da última versión pero xa hai un ficheiro co mesmo nome na mesma posición. Este ficheiro será sobrescrito polo novo.',
	...
	'INCOMPATIBLE_UPDATE_FILES'		=> 'Os ficheiros de actualización atopados son incompatíbeis coa túa versión instalada. A túa versión é a %1$s e o arquivo de actualización é para actualizar de phpBB %2$s a %3$s.',
	...
	'LOGIN_UPDATE_EXPLAIN'	=> 'Para poder levar a cabo a actualización debes iniciar sesión primeiro.',
	...
	'MERGING_FILES_EXPLAIN'		=> 'Actualmente recompilando trocos finais de arquivo.<br /><br />Agarda ata que o phpBB remate todas as operacións nos arquivos modificados.',
	...
	'NO_UPDATE_INFO'				=> 'É posíbel que non se atope a información dos ficheiros de actualización.',
	'NO_UPDATES_REQUIRED'			=> 'Non se precisan actualizacións',
	'NO_VISIBLE_CHANGES'			=> 'Non hai trocos visíbeis',
	'NOTICE'						=> 'Aviso',
	'NUM_CONFLICTS'					=> 'Número de conflitos',
	'NUMBER_OF_FILES_COLLECTED'		=> 'Actualmente comprobáronse diferenzas verbo de %1$d dun total de %2$d arquivos.<br />Agarda até que remate a comprobación de arquivos.',
	...
	'SQL'						=> 'SQL',
	'SQL_FAILURE_EXPLAIN'		=> 'Probabelmente non haxa nada de que preocuparse, a actualización continuará. En caso de non completarse pode que precises axuda dos foros de apoio. Mira <a href="../docs/README.html">README</a> para obter consello.',
	...
	'UPDATE_DATABASE_EXPLAIN'		=> 'O banco de datos será actualizado no seguinte paso.',
	'UPDATE_DATABASE_SCHEMA'		=> 'Actualizar estrutura da base de datos',
	'UPDATE_FILES'					=> 'Actualizar ficheiros',
	'UPDATE_FILES_NOTICE'			=> 'Asegúrate de ter actualizado os ficheiros do foro, este ficheiro é só para actualizar a base de datos.',
	'UPDATE_INSTALLATION'			=> 'Actualizar instalación phpBB ',
	'UPDATE_INSTALLATION_EXPLAIN'	=> 'Con esta opción, é posíbel actualizar o teu phpBB á última versión. <br />Durante o proceso comprobarase a integridade de todos os ficheiros. Podes revisar as diferenzas e os ficheiros antes da actualización. <br /><br /> A actualización pode facerse de dúas formas diferentes. </p><h2>Actualización manual</h2><p> Con esta actualización só descargas a túa configuración persoal de ficheiros cambiados para asegurarte de non perderes as modificacións feitas. Despois de descargado este paquete tes que transferir manualmente os ficheiros á súa correcta posición no directorio raíz do phpBB. Unha vez feito, podes verificar de novo a correcta localización. Se todo está ben serás dirixido á utilidade de actualización da base de datos.</p><h2>Actualización automática con FTP</h2><p> Este método é similar ao anterior pero non precisas descargar os ficheiros cambiados e transferilos ti mesmo. Isto farase automaticamente. Para usar este método precisas saber os detalles do acceso(login) FTP que che serán requiridos. Unha vez rematado serás redireccionado ao ficheiro de novo para verificar que se actualizou correctamente. Se é así avanzarás na utilidade de actualización da base de datos.',
	'UPDATE_INSTRUCTIONS'			=> '

		<h1>Anuncio de lanzamento</h1>

		<p>Le <a href="%1$s" title="%1$s"><strong>o anuncio de lanzamento para a última versión</strong></a> antes de seguir co teu proceso de actualización, pois pode que conteña información útil. Tamén ofrece ligazóns de descarga completa e o informe de trocos.</p>

		<br />

		<h1>Como actualizar a túa instalación co Paquete de Actualización Automática</h1>

		<p>O procedemento recomendado para actualizar a túa instalación listado aquí e válido só para o paquete de actualización automática. Podes tamén actualizar a túa instalación empregando os métodos indicados no documento INSTALL.html. Os pasos para actualizar o phpBB3 automaticamente son os seguintes:</p>
	...
	'UPDATE_INSTRUCTIONS_INCOMPLETE'	=> '
		...
		<p>O phpBB detectou unha actualización automática incompleta. Asegúrate de que seguiches cada un dos pasos do proceso da ferramenta de actualización automática. De seguido atoparás a ligazón de novo, ou podes ir directamente ao teu directorio de instalación.</p>
	',
	...
	'UPDATE_REQUIRES_FILE'			=> 'A utilidade de actualización precisa que estea presente o seguinte arquivo: %s',
	...
	'UPDATING_TO_LATEST_STABLE'		=> 'Actualizando base de datos á ultima versión estábel',
	...
	'VERSION_NOT_UP_TO_DATE'	=> 'A túa instalación do phpBB non está actualizada. Continúa o proceso de actualización.',
...
$lang = array_merge($lang, array(
	...
	'EXT_GROUP_DOWNLOADABLE_FILES'	=> 'Arquivos Descargábeis',
