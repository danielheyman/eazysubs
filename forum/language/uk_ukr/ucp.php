...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_EMAIL_CHANGED'	=> 'Ваш обліковий запис оновлено. Цей форум вимагає повторної активації облікового запису після зміни адреси e-mail. Ключ активації було надіслано на вашу нову адресу e-mail, яку ви вказали. Будь-ласка, перевірте вашу пошту для отримання додаткової інформації.',
...
$lang = array_merge($lang, array(
	...
	'ADD_FOES_EXPLAIN'	=> 'Ви можете ввести декілька імен користавачів, кожне на окремій стрічці',
	'ADD_FOLDER'	=> 'Додати папку',
	'ADD_FRIENDS'	=> 'Додати нових друзів',
	'ADD_FRIENDS_EXPLAIN'	=> 'Ви можете ввести декілька імен користавачів, кожне на окремій стрічці',
	...
	'BOOKMARKS'	=> 'Закладки',
	'BOOKMARKS_EXPLAIN'	=> 'Ви можете додати цю тему в закладки для перегляду в майбутньому. Для видалення закладок поставте галочку напроти тих, які ви хочете видалити і натисність кнопку <em>Видалити відмічені закладки</em>.',
	...
	'COPPA_EXPLAIN'	=> 'Будь-ласка, зауважте, що натискання кнопки "Відправка" створить ваш обліковий запис. Але він не буде активований допоки хтось з ваших батьків чи опікун схвалить вашу реєстрацію. По електронній пошті вам буде вислана копія необхідної форми з вказівками, куди її відправити.',
	...
	'FIELD_TOO_LONG'	=> 'Поле “%1$s” нато довге, максимально допустима довжина  %2$d символів.',
	...
	'NO_AUTH_READ_MESSAGE'	=> 'Ви не можете переглядати приватні повідомення.',
	...
	'POST_NEW_PM'	=> 'Відправити повідомення',
	...
	'USERNAME_ALPHA_ONLY_EXPLAIN'	=> 'Ім\'я користувача повинне мати довжину від %1$d до %2$d симолів та містити лише букви та числа',
	'USERNAME_ALPHA_SPACERS_EXPLAIN'	=> 'Ім\'я користувача повинне мати довжину від %1$d до %2$d симолів та містити лише букви та числа, пробіл і символи -+_[].',
	'USERNAME_ASCII_EXPLAIN'	=> 'Ім\'я користувача повинне мати довжину від %1$d до %2$d симолів та містити лише символи ASCII без спеціальних символів',
	'USERNAME_LETTER_NUM_EXPLAIN'	=> 'Ім\'я користувача повинне мати довжину від %1$d до %2$d симолів та містити лише букви та цифри',
	'USERNAME_LETTER_NUM_SPACERS_EXPLAIN'	=> 'Ім\'я користувача повинне мати довжину від %1$d до %2$d симолів та містити лише letter, цифри, пробіл або символи -+_[].',
	...
	'VIEW_POSTS_DAYS'	=> 'Відображати повідомленння за попередні дні',
	...
	'NO_PENDING'	=> 'Немає очікуючих на вступ до групи',
