...
$lang = array_merge($lang, array(
	...
	'COLLIDING_USERNAMES_FOUND'	=> 'На вашому старому форумі знайдено конфліктуючі імена користувачів. Для завершення конвертування, будь-ласка, видаліть або перейменуйте цих користувачів, щоб кожному очищеному користувачу відповідав один користувач вашого старого форуму.',
	...
	'CONTINUE_OLD_CONVERSION'	=> 'Продовжити раніше почате конвертуванння',
	...
	'CONV_ERROR_ATTACH_FTP_DIR'			=> 'Для старого форуму увімкнуто завантаження файлів по FTP. Будь-ласка, вимкніть опціюзавантаження по FTP та переконайтесь, що вірно вказано директорію завантаження, тоді скопіюйте усі приєднані файли до цієї дотупної через інтернет директорії. Після того, як ви зробите це, перезапустіть конвертер.',
	...
	'CONV_ERROR_INCONSISTENT_GROUPS'	=> 'Виявлено порушення цілосності таблиці груп в add_bots() - вам необхідно додати усі спеціальні групи вручну.',
	...
	'DB_HOST_EXPLAIN'			=> 'DSN - назва джерела даних при встановленні з використанням ODBC.',
	...
	'INSTALL_NEXT_FAIL'			=> 'Деякі тести не вдалось пройти, вам необхідно виправити ці проблеми до того, як ви перейдете до наступного етапу встанолення. В протилежному випадку встановлення не буде завершено.',
...
$lang = array_merge($lang, array(
	...
	'MERGING_FILES_EXPLAIN'		=> 'Наразі відбувається завершальна зміна файлів.<br /><br />Зачекайтесь, будь-ласка, коли phpBB звершить усі операції зі зміненими файлами.',
	...
	'STATUS_NEW_CONFLICT'		=> 'Новий конфіктуючий файл',
	...
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<p>Після завантаження ваш форум перейде в режим офлайн для звичайних користувачів, оскільки буде присутня завнтажена вами директорія install.<br /><br />
