...
$lang = array_merge($lang, array(
	...
	'ACP_FORUM_PERMISSIONS_COPY'	=> 'Капіраванне правоў доступу',
	...
	'ACP_MAIN'					=> 'Галоўная старонка панэлі адміністравання',
	'ACP_MANAGE_EXTENSIONS'		=> 'Пашырэнні',
	...
	'ACP_NO_ITEMS'				=> 'Няма аб\'ектаў для адлюстравання.',
	...
	'ACP_FEED'					=> 'Каналы навін',
	'ACP_FEED_SETTINGS'			=> 'Каналы навін',
	...
	'ACP_SEND_STATISTICS'		=> 'Статыстычныя дадзеныя',
	...
	'ACP_SUBMIT_CHANGES'		=> 'Зацвердзіць змены',
	...
	'ACP_USER_SIG'					=> 'Подпіс',
	'ACP_USER_WARNINGS'				=> 'Папярэджанні',

	'ACP_VC_SETTINGS'					=> 'Параметры анты-спам пацверджання ',
	...
	'ADM_LOGOUT'			=> 'Выхад',
	'ADM_LOGGED_OUT'		=> 'Вы паспяхова выйшлі з панэлі адміністравання.',
	...
	'LOGIN_ADMIN'			=> 'Для ўваходу ў панэль адміністравання вы павінны быць аўтарызаваныя.',
	'LOGIN_ADMIN_CONFIRM'	=> 'Для ўваходу ў панэль адміністравання неабходна паўторна ўвесці сваё імя і пароль.',
	'LOGIN_ADMIN_SUCCESS'	=> 'Праверка сапраўднасці прайшла паспяхова. Зараз вы будзеце перенаправлены ў панэль адміністравання.',
	...
	'MORE'					=> 'Падрабязней',			// Not used at the moment
	'MORE_INFORMATION'		=> 'Дадатковыя звесткі »',
	'MOVE_DOWN'				=> 'Уніз',
	'MOVE_UP'				=> 'Уверх',

	'NOTIFY'				=> 'Апавяшчэнне',
	'NO_ADMIN'				=> 'У вас няма правоў для доступу ў панэль адміністравання.',
	'NO_EMAILS_DEFINED'		=> 'Не знойдзена правільных адрасоў электроннай пошты.',
	'NO_PASSWORD_SUPPLIED'	=> 'Неабходна ўвесці пароль для атрымання доступу ў панэль адміністравання.',
...
// PHP info
$lang = array_merge($lang, array(
	'ACP_PHP_INFO_EXPLAIN'	=> 'Гэтая старонка адлюстроўвае звесткі аб версіі PHP, усталяванай на дадзеным серверы. Яна ўключае падрабязныя звесткі аб загружаных модулях, даступных пераменных і наладах па змаўчанні. Гэтая інфармацыя можа быць карыснай пры дыягнаставанні розных непаладак. Некаторыя хостынг-кампаніі абмяжоўваюць адлюстраванне гэтай інфармацыі па меркаваннях бяспекі. Не выдаваць ніякіх звестак з гэтай старонкі нікому, акрамя <a href="http://www.phpbb.com/about/team/">афіцыйных чальцоў групы падтрымкі</a>.',

	'NO_PHPINFO_AVAILABLE'	=> 'Звесткі аб PHP не вызначаныя. Функцыя phpinfo() адключаная па меркаваннях бяспекі.',
));
...
$lang = array_merge($lang, array(
	...
	'NO_ENTRIES'	=> 'Няма запісаў за пазначаны перыяд.',
...
// Index page
$lang = array_merge($lang, array(
	'ADMIN_INTRO'				=> 'Дзякуем за выбар phpBB у якасці рашэння для стварэння канферэнцыі. Дадзеная старонка падае кароткі агляд рознай статыстыкі. Спасылкі злева дазваляюць кіраваць усімі аспектамі працы вашай канферэнцыі. Кожная старонка ўтрымоўвае інструкцыі па выкарыстанні дзеючай прылады.',
	...
	'PHP_VERSION_OLD' 	=> 'Версія PHP на дадзеным серверы састарэла і не будзе падтрымлівацца будучымі версіямі phpBB. %sПадрабязней%s',

	'POSTS_PER_DAY'		=> 'Паведамленняў у дзень',

	'PURGE_CACHE'			=> 'Ачысціць кэш',
	'PURGE_CACHE_CONFIRM'	=> 'Вы сапраўды жадаеце ачысціць кэш?',
	'PURGE_CACHE_EXPLAIN'	=> 'Ачыстка ўсіх кэшыраваных элементаў, у тым ліку кэшыраваныя файлы шаблонаў і запыты.',

	'PURGE_SESSIONS'			=> 'Ачысьціць усе сесіі',
	'PURGE_SESSIONS_CONFIRM'	=> 'Вы сапраўды жадаеце ачысціць ўсе дзеючыя сесіі?',
	'PURGE_SESSIONS_EXPLAIN'	=> 'Ачыстка табліцы сесій. Сесіі ўсіх карыстальнікаў, якія знаходзяцца ў дадзены момант на канферэнцыі, будуць завершаныя, таму пасля выканання дадзенага дзеяння ім зноў давядзецца увайсці на канферэнцыю, увёўшы імя і пароль.',
	...
	'WRITABLE_CONFIG'		=> 'Файл <samp>config.php</samp> у цяперашні час даступны для запісу. Настойліва рэкамендуецца змяніць права доступу да гэтага файла на 640, або, прынамсі, на 644 (напрыклад: <a href="http://ru.wikipedia.org/wiki/Chmod" rel="external">chmod</a> 640 config.php).',
));
...
$lang = array_merge($lang, array(
	...
	'SORT_LAST_REMINDER'=> 'Апошні напамін',
	'SORT_REMINDER'		=> 'Дата напаміну',
...
$lang = array_merge($lang, array(
	'EXPLAIN_SEND_STATISTICS'	=> 'Дашліце нам інфармацыю аб вашым сэрвэры і канфігурацыі phpBB для статыстычнага аналізу. Уся інфармацыя, якая магла б ідэнтыфікаваць вас ці ваш сайт, сцёртая - дадзеныя цалкам <strong>ананімныя</ strong>. Грунтуючыся на прадастаўленай вамі інфармацыі, мы будзем прымаць рашэнні аб функцыянальнасці будучых версій phpBB. Статыстычныя дадзеныя прадстаўляюцца публічна. Мы таксама выкарыстоўваем гэтыя дадзеныя сумесна з праектам PHP (мова праграмавання, на якім напісаны phpBB).',
	'EXPLAIN_SHOW_STATISTICS'	=> 'Выкарыстоўваючы кнопку ніжэй, вы можаце праглядзець усе пераменныя, якія будуць перададзены.',
	'DONT_SEND_STATISTICS'		=> 'Пераход на галоўную старонку панэлі адміністравання',
	'GO_ACP_MAIN'				=> 'Пераход на галоўную старонку панэлі адміністравання',
	'HIDE_STATISTICS'			=> 'Не паказваць падрабязнасці',
	'SEND_STATISTICS'			=> 'Адпраўка статыстычнай інфармацыі',
	'SHOW_STATISTICS'			=> 'Паказаць падрабязнасці',
	'THANKS_SEND_STATISTICS'	=> 'Дзякуем за прадстаўленую вамі інфармацыю!',
));
...
$lang = array_merge($lang, array(
	...
	'LOG_CONFIG_FEED'			=> '<strong>Змененыя наладкі каналаў навін</strong>',
	...
	'LOG_CONFIG_VISUAL'			=> '<strong>Змененыя настройкі анты-спам пацверджання</strong>',

	'LOG_APPROVE_TOPIC'			=> '<strong>Ухваленая тэма</strong><br />» %s',
	'LOG_BUMP_TOPIC'			=> '<strong>Паднятая тэма</strong><br />» %s',
	'LOG_DELETE_POST'			=> '<strong>Выдаленае паведамленне «%1$s», апублікаванае карыстальнікам </strong> <br />» %2$s',
	'LOG_DELETE_SHADOW_TOPIC'	=> '<strong>Выдаленая спасылка на перанесеную тэму</strong><br />» %s',
	'LOG_DELETE_TOPIC'			=> '<strong>Выдаленая тэма «%1$s», створаная карыстальнікам </strong> <br />» %2$s',
	...
	'LOG_PM_REPORT_CLOSED'		=> '<strong>Зачыненая скарга на асабістае паведамленне</strong><br />» %s',
	'LOG_PM_REPORT_DELETED'		=> '<strong>Выдаленая скарга на асабістае паведамленне</strong><br />» %s',
	...
	'LOG_FORUM_COPIED_PERMISSIONS'			=> '<strong>Скапіяваныя правы доступу</strong> з форума «%1$s» у форум<br />» %2$s',
	...
	'LOG_USERS_PENDING'		=> '<strong>Карыстальнікі запыталі ўступлення ў групу «%1$s» і чакаюць адабрэння</strong><br />» %2$s',

	'LOG_IMAGE_GENERATION_ERROR'	=> '<strong>Памылка пры стварэнні выявы</strong><br />» Памылка ў %1$s у радку %2$s: %3$s',
	...
	'LOG_PURGE_SESSIONS'		=> '<strong>Ачыстка сесій</strong>',
	...
	'LOG_USER_DEL_OUTBOX'	=> '<strong>Вычышчаная папка «Выходныя» карыстальніка</strong><br />» %s',
	...
	'LOG_USER_REMOVED_NR'	=> '<strong>Выдалены сцяг новай рэгістрацыі карыстальніка</strong><br />» %s',
	...
	'LOG_WARNING_DELETED'		=> '<strong>Выдаленае папярэджанне ў карыстальніка</strong><br />» %s',
	'LOG_WARNINGS_DELETED'		=> '<strong>Выдаленае %2$s папярэджанняў у карыстальніка</strong><br />» %1$s', // Example: '<strong>Deleted 2 user warnings</strong><br />» username'
	'LOG_WARNINGS_DELETED_ALL'	=> '<strong>Выдаленыя ўсе папярэджання ў карыстальніка</strong><br />» %s',
