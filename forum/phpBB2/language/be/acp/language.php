...
$lang = array_merge($lang, array(
	...
	'ACP_LANGUAGE_PACKS_EXPLAIN'	=> 'Тут вы можаце ўсталёўваць і выдаляць моўныя пакеты. Моўны пакет, які выкарыстоўваецца на канферэнцыі па змоўчванні, пазначаны зорачкай (*).',
