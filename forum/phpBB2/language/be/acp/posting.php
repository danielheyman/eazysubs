...
$lang = array_merge($lang, array(
	'ACP_BBCODES_EXPLAIN'		=> 'BBCode - гэта адмысловая рэалізацыя мовы HTML, якая прадстаўляе больш зручныя магчымасці па фарматаваньню паведамленняў. З дапамогай гэтай старонкі вы можаце дадаваць, выдаляць і змяняць BBCodes.',
	'ADD_BBCODE'				=> 'Дадаць BBCode',

	'BBCODE_DANGER' 		=> 'Гэты BBCode выкарыстоўвае лексему {TEXT} ў тегах HTML. Гэта можа стварыць праблемы з бяспекай, звязаныя з XSS (межсайтавым скрыптынгам). Паспрабуйце ўжыць лексемы {SIMPLETEXT} або {INTTEXT}, якія выкарыстоўваюць больш строгія праверкі. Ігнаруйце дадзенае папярэджанне толькі ў выпадку, калі цалкам усведамляеце магчымыя рызыкі, і выкарыстанне лексемы {TEXT} абсалютна неабходна.', 
	'BBCODE_DANGER_PROCEED' 	=> 'Працягнуць', //'Я ўсьведамляю рызыку',
	...
	'BBCODE_USAGE_EXPLAIN'		=> 'Тут вызначаецца выкарыстанне BBCode. Любая ўводзеная пераменная можа быць замененая на адпаведную лексему (%sпрыклады ніжэй%s).',
	...
	'TOKEN'					=> 'Лексема',
	'TOKENS'				=> 'Лексемы',
	'TOKENS_EXPLAIN'		=> 'Лексемы з\'яўляюцца пазнакамі-запаўняльнікамі для ўводзімага карыстальнікам змесціва. Правільнасць уведзенага змесціва будзе пацверджаная толькі ў выпадку, калі яно адказвае адпаведнаму азначэнню. Калі неабходна, вы можаце нумараваць іх шляхам дадання нумара ў канцы лексемы ўсярэдзіне фігурных дужак, напрыклад, {TEXT1}, {TEXT2}.<br /><br />У якасці пазанак-запаўняльнікаў вы таксама можаце выкарыстаць любую з моўных пераменных, якія прысутнічаюць у вашай моўнай папцы (language/), напрыклад: {L_<em>&lt;STRINGNAME&gt;</em>}, дзе <em>&lt;STRINGNAME&gt;</em> — гэтае імя перакладзенага радка, якую вы жадаеце дадаць. Напрыклад, {L_WROTE} будзе адлюстравана як «wrote» або яго пераклад у адпаведнасці з мовай карыстальніка.<br /><br /><strong>Улічыце, што толькі лексемы, пералічаныя ніжэй, могуць быць скарыстаныя ў карыстальніцкіх BBCodes.</strong>',
	...
	'tokens'	=>	array(
		...
		'INTTEXT' 		=> 'Сімвалы Unicode, лічбы, прабелы, коскі, кропкі, мінус, плюс, злучок, падкрэсленне',
		...
		'URL'			=> 'Правільны адрас URL з выкарыстаннем любога пратаколу (http, ftp і г.д. не могуць выкарыстоўвацца для дэструктыўных дзеянняў JavaScript). Калі нічога не зададзена, то да радка будзе аўтаматычна дададзены прэфікс «http://».',
...
$lang = array_merge($lang, array(
	...
	'SMILIE_NO_CODE' 	=> 'Смайлік «%s» не быў дададзены, так як для яго не зададзены код.',
	'SMILIE_NO_EMOTION' 	=> 'Смайлік «%s» не быў дададзены, так як для яго не зададзеная эмоцыя.',
	...
	'TOO_MANY_SMILIES'			=> 'Дасягнутая мяжа ў колькасці %d смайлікаў.',
...
$lang = array_merge($lang, array(
	...
	'RANK_IMAGE_IN_USE'		=> '(выкарыстоўваецца)',
