...
$lang = array_merge($lang, array(
	...
	'CONFIRM_QUESTION_EXPLAIN'	=> 'Această întrebare este o metoda de a preveni trimiterile automate de către boţi de spam.',
	...
	'QUESTIONS'					=> 'Întrebări',
	'QUESTIONS_EXPLAIN'			=> 'Pentru fiecare trimitere de formular la care aţi activat componenta Întrebări&amp;Răspunsuri utilizatorii vor fi întrebaţi folosind una din întrebările specificate aici. Pentru a folosi acest modul, cel puţin o întrebare trebuie specificată în limba standard. Aceste întrebări ar trebui să aiba un răspuns simplu pentru ca audienţa forumului să poată răspunde dar să nu permită unui robot ce foloseşte căutările Google să găsească răspunsul. Cele mai bune rezultate se obţin folosind un set mare de intrebări ce ar trebui schimbat frecvent. Activaţi verificarea strictă dacă întrebarea se bazează pe litere mari şi mici, punctuaţie sau spaţii albe.',
	'QUESTION_DELETED'			=> 'Întrebare ştearsă',
	'QUESTION_LANG'				=> 'Limbă',
	'QUESTION_LANG_EXPLAIN'		=> 'Limba în care a fost compusă această intrebare şi răspunsurile corespunzătoare.',
    ...
    'QA_LAST_QUESTION'			=> 'Nu puteţi şterge toate întrebările cât timpul componenta captcha este activă.',
));
