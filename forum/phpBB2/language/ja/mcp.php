...
$lang = array_merge($lang, array(
	...
	'MERGE_TOPIC_EXPLAIN'	=> 'ここでは選択した記事を他のトピックに統合できます。選択された記事は新しい返信記事として統合先トピックへそのまま追加されます。<br />統合先トピックの ID 番号を入力するか、 “トピック選択” をクリックして統合先トピックを検索してください。トピックの ID 番号はトピック表示ページの URL 中に含まれています （“t=” 直後の数字列) 。',
