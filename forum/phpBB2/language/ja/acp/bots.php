...
$lang = array_merge($lang, array(
	'BOTS'				=> 'ボットの管理',
	'BOTS_EXPLAIN'		=> 'ボット、スパイダー、クローラーとはロボット型ウェブページ巡回プログラムの事であり、そのほとんどは検索エンジンです。これらが “ゲスト” ユーザーとしてサイトにアクセスした場合、セッションをめったに正常に扱わないためオンラインユーザー数をおかしくしたり、一般ユーザーのページの読み込み時間を増大させたり、検索されたくないワードまでもインデクスしてしまったりします。ここではこれらの問題に対処するため、どのユーザーエージェントまたは IPアドレス が “ボット” ユーザーなのかを指定できます。',
	'BOT_ACTIVATE'		=> '有効にする',
	...
	'BOT_LANG'			=> '言語',
	'BOT_LANG_EXPLAIN'	=> 'ボットがどの言語でインデクスするかを指定できます',
