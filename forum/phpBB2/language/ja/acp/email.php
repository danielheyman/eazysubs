...
$lang = array_merge($lang, array(
	'ACP_MASS_EMAIL_EXPLAIN'		=> 'ここでは全登録ユーザーまたは<strong>一括メールの受信オプションを有効に設定している</strong>グループにメールを送信できます。 一括メールとは実は、宛先に管理人のメールアドレスを、BCC（ブラインド・カーボン・コピー）に受信ユーザーの全メールアドレスをセットして送信したメールの事です。デフォルトでは１つの一括メールにつき受信ユーザー数は最大で５０人です。５０人以上のユーザーを指定した場合、一括メールは複数回に亘って送信されます。その場合、送信処理が終わるまでこのページから移動しないでください。一括メールには時間がかかるのが普通です。メール送信処理が完全に終了するとその旨のメッセージが表示されます。',
	'ALL_USERS'						=> '全ユーザー',
