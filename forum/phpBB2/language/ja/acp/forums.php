...
$lang = array_merge($lang, array(
	...
	'FORUM_ADMIN'						=> 'フォーラム管理',
	'FORUM_ADMIN_EXPLAIN'				=> 'phpBB3 のシステムを構成する基本的な概念は “フォーラム” です。いかなるフォーラムも無限に（サブ）フォーラムを持つことが可能であり、それらフォーラム個々についてフォーラムタイプをカテゴリ、フォーラム、リンクのどれかから指定する必要があります。ここではフォーラムの追加、編集、削除、閉鎖、閉鎖解除などを行えます。もしフォーラムのトピック数、投稿数、トピックの返信数、閲覧数がトピックの削除などによって正確なカウント数でなくなっている場合、同期によってカウント数を正確にできます。<strong>フォーラムを作成する際は設定オプション “パーミッションのコピー” の利用をお勧めします。フォーラムパーミッションが適切に設定されていないとそのフォーラムは入室はおろか表示すらされませんのでご注意ください。</strong>',
