...
$lang = array_merge($lang, array(
	...
	'ADMIN_LOG'					=> 'Admin ログ',
	'ADMIN_LOG_INDEX_EXPLAIN'	=> 'Admin によって実行された最近５件のアクションです。全ログを確認するには次のリンクをクリックしてください。',
...
$lang = array_merge($lang, array(
	...
	'INACTIVE_USERS_EXPLAIN_INDEX'	=> 'アカウントが無効（停止）状態の登録ユーザーの最近１０件のリストです。全ての無効アカウントを確認するには次のリンクをクリックしてください。移動先のページでアカウントの有効化、削除、アカウント有効化メールの送信を行うことができます。',
