...
$lang = array_merge($lang, array(
	...
	'MIN_CHAR_LIMIT_EXPLAIN'		=> '記事/PM に最低限書き込む必要のある文字数です',
	'POSTING'						=> '投稿',
...
$lang = array_merge($lang, array(
	...
	'ACC_ACTIVATION_EXPLAIN'	=> '無効 ： ユーザー登録を停止します<br />なし ： 自動的にアカウントを有効化します<br />ユーザー ： アカウント有効化メールを送信します<br />Admin ： Admin が手動でアカウントを有効化します<br /><em>掲示板のメール機能を無効化している場合、“ユーザー” と “Admin” は表示されません。</em>',
	...
	'NEW_MEMBER_GROUP_DEFAULT_EXPLAIN'	=> '“はい” に設定し、且つ “一見さん卒業までの投稿数” を 0 以外に指定している場合、新しく登録したユーザーのデフォルトグループは <em>登録ユーザー</em> ではなく <em>一見さん</em> に設定されます。デフォルトグループとはユーザーのグループカラー・グループランク・グループアバターを決定するためのグループです。この設定は <em>一見さん</em> と <em>登録ユーザー</em> をグループカラー・グループランク・グループアバターで区別している場合に意味があります。',
