...
$help = array(
	...
	array(
		0 => 'コードまたは固定幅データの表示',
		1 => 'プログラムのコード や タブ・スペースなどの固定幅が必要な表データ を表示するには、そのテキストを [code][/code] で囲みます：<br /><br /><strong>[code]</strong>echo &quot;これはプログラムのコードです&quot;;<strong>[/code]</strong><br /><br /> <strong>[code][/code]</strong> で囲まれた部分が固定幅で表示されます。 <strong>[code=php][/code]</strong> とすると if(){} や while(){} などの PHP構文 をハイライト表示することができ、PHPコード が読みやすくなるのでお勧めです。'
	),
	array(
		0 => '--',
		1 => 'リストの作成'
	...
	array(
		...
		1 => 'もしあなたが Admin ユーザーで且つ BBCode作成 のパーミッションを与えられていれば、AdminCP で新しい BBCode を追加できます。'
	)
);
