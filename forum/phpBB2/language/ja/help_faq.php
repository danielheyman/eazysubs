...
$help = array(
	...
	array(
		...
		1 => '過去にユーザー登録した際に送信されたメールをお探しください。そのメールにユーザー名とパスワードが記されています (セキュリティ上の理由でパスワードは記されていない可能性があります) 。もしかしたら何らかの理由で管理人が既にアカウントを無効化しているか削除している可能性もあります。また大抵の掲示板はデータベースのサイズを少しでも減らすため、長い間投稿していないユーザーのアカウントを定期的に削除するように設定しています。もしアカウントが削除されている場合、もう一度ユーザー登録してください。そして削除されないようフォーラムに積極的に参加するようにしてください。'
	),
	array(
		0 => 'COPPA とは？',
	...
	array(
		...
		1 => 'あなたの母語へ翻訳された言語パック （以下 “母言語パック” ） が掲示板にインストールされていません。母言語パックを掲示板にインストールできるかどうかを管理人に訊いてみてください。もし母言語パックがまだ作成されていない場合、ご自分で母言語パックを作成して頂いてかまいません。詳細は phpBB Group のウェブサイトをご覧ください （このページの一番下にリンクがあります） 。'
	),
	array(
