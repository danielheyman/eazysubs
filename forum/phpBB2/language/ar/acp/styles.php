...
$lang = array_merge($lang, array(
    ...
    'DELETE_STYLE_EXPLAIN'      => 'هنا يمكنك إزالة الستايلات. لا تستطيع إزالة جميع عناصر الستايل من هنا. ينبغي أن تحذفها من الأماكن المُخصصة لحذفها. كن حذراً في هذه العملية فلا يوجد خيار لاستعادة الستايلات المحذوفة.',
