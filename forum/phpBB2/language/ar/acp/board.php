...
$lang = array_merge($lang, array(
	'SYSTEM_TIMEZONE_EXPLAIN'	=> 'الوقت المستخدم ليظهر لغير المسجلين ( الزوار ، محركات البحث ) مسجلي الدخول سيقومون بتعين الوقت المستخدم خلال عملية التسجيل في المنتدى و يمكنهم تغير ذلك من خلال لوحة الملف الشخصي الخاص بهم .',
