...
<br /> در اين صفحه آمار بخش هاي مختلف انجمن شما و منوهاي مديريتي اصلي (در سمت راست و سربرگ ها) قرار گرفته است كه مي توانيد از آن ها براي مديريت انجمن بهره ببريد.<br />
	...
	<a href="http://index.maghsad.com/viewtopic.php?f=75&t=3686">
...
<br /><br />
	...
	<strong>لینک های پر کاربرد</strong>
	<br />
	برای ثبت سایت خود در لیست سایت های استفاده کننده از خدمات مقصد<a href=" http://index.maghsad.com/viewtopic.php?f=87&t=3651/ "> 
اینجا کلیک کنید</a>.
<br />
برای شرکت در توسعه و اصلاح هسته فارسی و فارسی ساز 
phpBB<a href="http://index.maghsad.com/viewtopic.php?p=11810#p11810"> 
اینجا کلیک کنید</a>.	<br />
در صورت نیاز به هاست رایگان<a href=" http://Maghsad.com/ "> 
اینجا کلیک کنید</a>.
<br />
<br />
<strong>مشخصات هسته فارسی :</strong>
			<br />	
هسته فارسی  phpBB 3.0.8<br />
نگارش هسته فارسي : 1.3.0 آزمایشی<br />
تاريخ انتشار آخرین نگارش هسته فارسی : 28 آبان 1388<br />
نگارش آخرین اصلاحیه نصب شده هسته فارسی : چهارشنبه 17 آذر 1389 <br />
اعضای تیم توسعه phpBB فارسی:
<a href="http://index.maghsad.com/armansoftware-u3195/">
Mafco</a> , <a href="http://index.maghsad.com/mafco-u1361/">
ArmanSoftware</a>.<br /><br />
