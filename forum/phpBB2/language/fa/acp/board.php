...
$lang = array_merge($lang, array(
	...
	اعضا در زمان ثبت نام و همچنین از مرکز مدیریت کاربری می توانند این زمان را تعیین کنند.',
	...
	'BUMP_INTERVAL_EXPLAIN'	=> 'تعداد دقيقه ها ، ساعت ها و روزها باي دستيابي به توانايي بامپ مبحث.مقدار 0 برای غیرفعال کزدن می باشد',
...
// 3.0.8 www.phpBB.Maghsad.com Changes END
	...
	'MAX_LOGIN_ATTEMPTS_EXPLAIN'	=> 'پس از این تعداد تلاش ناموفق برای ورود، کاربران باید کد ضد روبات را حل کنند.',
