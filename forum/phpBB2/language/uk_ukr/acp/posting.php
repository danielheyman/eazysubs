...
$lang = array_merge($lang, array(
	...
	'ADD_BBCODE'				=> 'Додати новий код BBCode',
 	...
 	'BBCODE_DANGER'				=> 'BBCode, який ви намагаєтесь додати, здається, використовує лексему {TEXT} всередині атрибуту HTML. Це може призвести до проблем з безпекою, пов\'язаних з XSS. Спробуйте використати лексеми {SIMPLETEXT} або {INTTEXT}, які використовують більше перевірок. Продовжуйте лише у тому випадку, якщо ви цілком розумієте можливі ризики та використання лексеми {TEXT} абослютно необхідне.',
