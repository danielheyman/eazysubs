...
$lang = array_merge($lang, array(
	...
	'IP_UNBAN_EXPLAIN'	=> 'Ви можете розблокувати декілька IP-адрес,  обравши їх за допомогою відповідної комбінації миші та клавіатури вашого комп\'ютера та браузера. Виключені IP-адреси виділяються іншим кольором фону.',
	'PERMANENT'	=> 'Постійна',
	'UNTIL'	=> 'До',
