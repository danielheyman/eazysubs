...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		<p>Права доступу надзвичайно деталізовані і згруповані в чотори основних розділи:</p>
	...
	'ACP_FORUM_PERMISSIONS_EXPLAIN'				=> 'Тут ви можете змінювати права доступу до форумів для користувачів та груп. Для призначення модераторів та адіміністраторів, будь-ласка, використовуйте відповідний розділ.',
	...
	'DELETE_ROLE_CONFIRM'		=> 'Ви впевнені, що хочете видалити цю роль? Елементи з даною роллю <strong>не</strong> втратать налаштування доступу.',
	...
	'RESULTING_PERMISSION'			=> 'Результуючі права доступу',
	'ROLE'							=> 'Роль',
	...
	'ROLE_FORUM_STANDARD'		=> 'Стандартний доступ',
 	'ROLE_FORUM_NEW_MEMBER'		=> 'Нові користувачі',
	...
	'ROLE_USER_STANDARD'		=> 'Стандартні можливості',
 	'ROLE_USER_NEW_MEMBER'		=> 'Новий користувач',
	...
	'ROLE_DESCRIPTION_FORUM_LIMITED'		=> 'Може використовувати деякі можливості форуму, але не може приєднавати файли або використовувати значки повідомлень.',
	'ROLE_DESCRIPTION_FORUM_LIMITED_POLLS'		=> 'Аналогічно до Обмеженого доступу, але з можливістю створення голосувань.',
	'ROLE_DESCRIPTION_FORUM_NOACCESS'		=> 'Немає прав бачити та заходити на форум.',
	...
	'TRACE_GROUP_NEVER_TOTAL_NEVER'	=> 'Встановлене значення права доступу для цієї групи -  <samp>НІКОЛИ</samp> відповідає результуючому, тому збережено раніше встановлене значення.',
	'TRACE_GROUP_NEVER_TOTAL_NEVER_LOCAL'	=> 'Встановлене значення права групи для цього форуму - <samp>НІКОЛИ</samp> відповідає результуючому , тому збережено раніше встановлене значення.',
	'TRACE_GROUP_NEVER_TOTAL_NO'	=> 'Встановлене значення права доступу для цієї групи -  <samp>НІКОЛИ</samp>, яке стає новим результуючим значенням, оскільки воно не було задане раніше (встановлено в <samp>НІ</samp>).',
	'TRACE_GROUP_NEVER_TOTAL_NO_LOCAL'	=> 'Встановлене значення права групи для цього форуму - <samp>НІКОЛИ</samp>, яке стає новим результуючим значенням, оскільки воно не було задане раніше (встановлено в <samp>НІ</samp>).',

	'TRACE_GROUP_NEVER_TOTAL_YES'	=> 'Встановлене значення права доступу для цієї групи -  <samp>НІКОЛИ</samp> замінює встановлене результуюче <samp>ТАК</samp> на <samp>НІКОЛИ</samp> для даного користувача.',
	'TRACE_GROUP_NEVER_TOTAL_YES_LOCAL'	=> 'Встановлене значення права групи для цього форуму - <samp>НІКОЛИ</samp> замінює встановлене результуюче <samp>ТАК</samp> на <samp>НІКОЛИ</samp> для даного користувача.',	
	...
	'TRACE_GROUP_YES_TOTAL_NEVER'	=> 'Встановлене значення права доступу для цієї групи -  <samp>ТАК</samp>, але результуюче <samp>НІКОЛИ</samp> не може бути замінено.',
	'TRACE_GROUP_YES_TOTAL_NEVER_LOCAL'	=> 'Встановлене значення права групи для цього форуму - <samp>ТАК</samp>, але результуюче <samp>НІКОЛИ</samp> не може бути замінено.',
	'TRACE_GROUP_YES_TOTAL_NO'		=> 'Встановлене значення права доступу для цієї групи -  <samp>ТАК</samp>, яке стає новим результуючим значенням, оскільки воно не було задане раніше (встановлено в <samp>НІ</samp>).',
	'TRACE_GROUP_YES_TOTAL_NO_LOCAL'	=> 'Встановлене значення права групи для цього форуму - <samp>ТАК</samp>, яке стає новим результуючим значенням, оскільки воно не було задане раніше (встановлено в <samp>НІ</samp>).',
	'TRACE_GROUP_YES_TOTAL_YES'		=> 'Встановлене значення права доступу для цієї групи -  <samp>ТАК</samp> і результуюче право також <samp>ТАК</samp>, тому збережено раніше встановлене значення.',
	'TRACE_GROUP_YES_TOTAL_YES_LOCAL'	=> 'Встановлене значення права групи для цього форуму - <samp>ТАК</samp> і результуюче право також <samp>ТАК</samp>, тому збережено раніше встановлене значення.',
	...
	'TRACE_USER_GLOBAL_YES_TOTAL_YES'		=> 'Незалежно від форуму встановлене право доступу користувача - <samp>ТАК</samp>, але результуюче значення права доступу вже встанолено в <samp>ТАК</samp>, тому збережено раніше встановлене значення. %sВідслідкувати глобальне право доступу%s',
	...
	'TRACE_USER_NEVER_TOTAL_NEVER'			=> 'Встановлене значення права користувача -  <samp>НІКОЛИ</samp> і результуюче право також <samp>НІКОЛИ</samp>, нічого не змінено.',
	'TRACE_USER_NEVER_TOTAL_NEVER_LOCAL'	=> 'Встановлене значення права користувача для цього форуму - <samp>НІКОЛИ</samp> і результуюче право також <samp>НІКОЛИ</samp>, нічого не змінено.',
	'TRACE_USER_NEVER_TOTAL_NO'				=> 'Встановлене значення права користувача - <samp>НІКОЛИ</samp>, яке стає новим результуючим, оскільки було встановлено НІ.',
	'TRACE_USER_NEVER_TOTAL_NO_LOCAL'		=> 'Встановлене значення права користувача для цього форуму - <samp>НІКОЛИ</samp>, яке стає новим результуючим, оскільки було встановлено НІ.',
	...
	'TRACE_USER_NO_TOTAL_NO'				=> 'Встановлене значення права користувача - <samp>НІ</samp> і результуюче право було встановлено в НІ, тому встановлено значення за замовчуванням - <samp>НІКОЛИ</samp>.',
	'TRACE_USER_NO_TOTAL_NO_LOCAL'			=> 'Встановлене значення права користувача для цього форуму - <samp>НІ</samp> і результуюче право було встановлено в НІ, тому встановлено значення за замовчуванням - <samp>НІКОЛИ</samp>.',
	'TRACE_USER_YES_TOTAL_NEVER'			=> 'Встановлене значення права користувача - <samp>ТАК</samp>, але результуюче <samp>НІКОЛИ</samp> не може бути замінено.',
	'TRACE_USER_YES_TOTAL_NEVER_LOCAL'		=> 'Встановлене значення права користувача для цього форуму - <samp>ТАК</samp>, але результуюче <samp>НІКОЛИ</samp> не може бути замінено.',
	'TRACE_USER_YES_TOTAL_NO'				=> 'Встановлене значення права користувача - <samp>ТАК</samp>, яке стає новим результуючим, оскільки було встановлено <samp>НІ</samp>.',
	'TRACE_USER_YES_TOTAL_NO_LOCAL'			=> 'Встановлене значення права користувача для цього форуму - <samp>ТАК</samp>, яке стає новим результуючим, оскільки було встановлено <samp>НІ</samp>.',
	'TRACE_USER_YES_TOTAL_YES'				=> 'Встановлене значення права користувача - <samp>ТАК</samp>  і результуюче право також <samp>ТАК</samp>, нічого не змінено.',
	'TRACE_USER_YES_TOTAL_YES_LOCAL'		=> 'Встановлене значення права користувача для цього форуму - <samp>ТАК</samp>  і результуюче право також <samp>ТАК</samp>, нічого не змінено.',
	'TRACE_WHO'								=> 'Хто',
