...
$lang = array_merge($lang, array(
	...
	'CAPTCHA_FONT_LOWER'               => 'Додатково використовувати нижній регістр',
 	...
 	'CAPTCHA_SELECT' => 'Встановлені модулі CAPTCHA', 
 	'CAPTCHA_SELECT_EXPLAIN' => 'У цьому випадаючому списку містяться модулі CAPTCHA, розпізнані вашим форумом. Модулі, які позначено сірим кольором, наразі недоступні, та можливо, потребують попереднього налаштування перед використанням.', 
 	'CAPTCHA_CONFIGURE' => 'Налаштування CAPTCHA', 
 	'CAPTCHA_CONFIGURE_EXPLAIN' => 'Зміна налаштувань для обраного модуля CAPTCHA.', 
 	'CONFIGURE' => 'Налаштування', 
 	'CAPTCHA_NO_OPTIONS' => 'Цей модуль CAPTCHA не має параметрів для налаштування.',
	...
	'VISUAL_CONFIRM_REFRESH_EXPLAIN'      => 'Дозволяє користувачам надсилати запит на отримання нових кодів підтвердження, якщо вони не можуть прочитати їх під час реєстрації. Деякі модулі можуть не підтримувати дану функцію.',
));
