...
// Forum Pruning
$lang = array_merge($lang, array(
	'ACP_PRUNE_FORUMS_EXPLAIN'	=> 'การกระทำนี้จะลบกระทู้ใดๆ ที่ไม่มีการโพสต์หรือดูในช่วงเวลาที่คุณกำหนด ถ้าคุณไม่ใส่จำนวนวัน ทุกกระทู้จะถูกลบ โดยปกติจะไม่มีการลบกระทู้ที่มีแบบสำรวจค้างอยู่ และจะไม่ลบ stickies และประกาศ',
