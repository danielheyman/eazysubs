...
$lang = array_merge($lang, array(
	...
	'ROLE_FORUM_BOT'			=> 'การเข้าใช้งานของ Bot',
	'ROLE_FORUM_FULL'			=> 'เข้าใช้งานแบบเต็มรูปแบบ',
	'ROLE_FORUM_LIMITED'		=> 'จำกัดการเข้าใช้งาน',
	'ROLE_FORUM_LIMITED_POLLS'	=> 'จำกัดการเข้าใช้งาน + โพล',
	'ROLE_FORUM_NOACCESS'		=> 'ไม่ใช้ใช้งาน',
	'ROLE_FORUM_ONQUEUE'		=> 'On Moderation Queue',
	'ROLE_FORUM_POLLS'			=> 'เข้าใช้งาน + โพล',
	...
	'ROLE_DESCRIPTION_FORUM_FULL'			=> 'สามารถใช้ features ทั้งหมด, รวมทั้งการโพสต์ประกาศและ stickies. สามารถละเลย flood limit ได้ด้วย<br /> ไม่แนะนำสำหรับผู้ใช้ทั่วไป',
