...
$lang = array_merge($lang, array(
	'AUTO_PRUNE_DAYS'			=> 'อายุการโพสต์ของ Auto-prune',
	...
	'FORUM_ADMIN_EXPLAIN'				=> 'ใน phpBB3 ทุกอย่างเป็น บอร์ด based แต่ละบอร์ดสามารถมีจำนวนบอร์ดย่อยได้ไม่จำกัด และสามารถกำหนดว่าอันไหนสามารถโพสต์ได้หรือไม่ได้ คุณสามารถเพิ่ม แก้ไข ลบ ล็อค แก้ล็อค แต่ละบอร์ด ได้เหมือนกับการควบคุมเพิ่มเติม ถ้าโพสต์และกระทู้ไม่ sync คุณสามารถ resynchronise forum <strong>คุณต้องคัดลอกหรือตั้งค่าการอนุญาตที่เหมาะสมให้กับบอร์ดที่สร้างขึ้น เพื่อให้สามารถใช้การได้</strong>',
