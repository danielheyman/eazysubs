...
'MORE_INFORMATION'=> 'Više informacija Â»',
...
'SETTING_TOO_LOW'=> 'Vrijednost za postavku â€œ%1$sâ€ je preniska. Minimalna dopuštena vrijednost je %2$d.',
'SETTING_TOO_BIG'=> 'Vrijednost za postavku â€œ%1$sâ€ je previsoka. Maksimalna dopuštena vrijednost je %2$d.',
'SETTING_TOO_LONG'=> 'Vrijednost za postavku â€œ%1$sâ€ je predugačka. Maksimalna dopuštena dužina je %2$d.',
'SETTING_TOO_SHORT'=> 'Vrijednost za postavku â€œ%1$sâ€ je prekratka. Minimalna dopuštena dužina je %2$d.',
...
'LOG_PM_REPORT_CLOSED'=> '<strong>Zatvorena prijava privatne poruke</strong><br />Â» %s',
'LOG_PM_REPORT_DELETED'=> '<strong>Izbrisana prijava privatne poruke</strong><br />Â» %s',
...
'LOG_FORUM_COPIED_PERMISSIONS'=> '<strong>Kopirana dopuštenja foruma</strong> od %1$s<br />Â» %2$s',
...
'LOG_USERS_APPROVED'=> '<strong>Odobreni korisnici u korisničkoj grupi</strong> %1$s<br />Â» %2$s',
'LOG_USERS_PENDING'=> '<strong>Korisnici su zatražili pristup grupi â€œ%1$sâ€ i trebaju biti odobreni</strong><br />Â» %2$s',
'LOG_IMAGE_GENERATION_ERROR'=> '<strong>Greška prilikom stvaranja slike</strong><br />Â» Greška u %1$s na liniji %2$s: %3$s',
...
'LOG_USER_DEL_OUTBOX'=> '<strong>Izbrisan sadržaj korisnikovog Odlaznog sandučića</strong><br />Â» %s',
...
'LOG_USER_REMOVED_NR'=> '<strong>Uklonjena oznaka novog korisnika/ce sa korisničkog računa</strong><br />Â» %s',
...
'LOG_WARNING_DELETED'=> '<strong>Izbrisano upozorenje korisnika/ce</strong><br />Â» %s',
'LOG_WARNINGS_DELETED'=> '<strong>Izbrisana %2$s upozorenja korisnika/ce</strong><br />Â» %1$s', // Primjer: '<strong>Izbrisana 2 upozorenja korisnika/ce</strong><br />Â» username'
'LOG_WARNINGS_DELETED_ALL'=> '<strong>Izbrisana sva upozorenja korisnika/ce</strong><br />Â» %s',
