...
'ACP_FEED_OVERALL_FORUMS_EXPLAIN'=> 'Omogućuje feed â€œSvih forumaâ€ koji prikazuje listu foruma.',
...
'LDAP_PASSWORD_EXPLAIN'=> 'Ostavi prazno za anonimno povezivanje ili upiši zaporku za gornjeg/u korisnika/cu. Potrebno za Active Directory servere.<br /><em><strong>Upozorenje:</strong> Zaporka će biti pohranjena u bazu kao običan tekst i vidljiva svima koji imaju pristup bazi odnosno ovoj konfiguracijskoj stranici.</em>',
...
'ENABLE_EMAIL_EXPLAIN'=> 'Ukoliko je ovo isključeno, e-mail poruke neće biti slane od strane foruma. <em>Napomena da korisnički i administratorski način aktivacije računa zahtijevaju da ova opcija bude uključena. Ukoliko se koristi korisnička ili administratorska aktivacijska opcija u aktivacijskim postavkama, isključivanje ove opcije neće zahtijevati aktivaciju novih računa.</em>',
...
'SMTP_PASSWORD_EXPLAIN'=> 'Unesi zaporku samo ukoliko to SMTP server zahtijeva.<br /><em><strong>Upozorenje:</strong> Zaporka će biti pohranjena u bazu kao običan tekst i vidljiva svima koji imaju pristup bazi, tj. ovoj konfiguracijskoj stranici.</em>',
'SMTP_PLAIN'=> 'PLAIN',
...
'JAB_PASSWORD_EXPLAIN'=> '<em><strong>Upozorenje:</strong> Zaporka će biti pohranjena u bazu kao običan tekst i vidljiva svima koji imaju pristup bazi, tj. ovoj konfiguracijskoj stranici.</em>',
