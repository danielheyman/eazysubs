...
$help = array(
	...
	array(
		...
		1 => 'Да, наравно да можете, на пример да бисте привукли нечију пажњу можете писати:<br /><br /><strong>[size=200][color=red][b]</strong>ПОГЛЕДАЈ МЕ!<strong>[/b][/color][/size]</strong><br /><br />даће <span style="color:red;font-size:200%;"><strong>ПОГЛЕДАЈ МЕ!</strong></span><br /><br />Не препоручујемо да пишете пуно текста који изгледа овако! Запамтите да је на Вама, односно писцу, да се побринете да су тагови правилно затворени. На пример следеће је неисправно:<br /><br /><strong>[b][u]</strong>Ово је погрешно<strong>[/b][/u]</strong>'
	),
	array(
		0 => '--',
