...
$lang = array_merge($lang, array(
	...
	'BOTS_EXPLAIN'		=> '“Роботи”, “пауци” или “crawlers” су аутоматски агенти обично коришћени од претраживача за ажурирање њихових база. Обзиром да они ретко када правилно користе сесије то они могу изокренути број посетилаца, повећати оптерећење и понекад не успети да индексирају веб страницу исправно. Овде можете да одредите посебан тип корисника како би превазишли ове сметње.',
	...
	'ERR_BOT_NO_MATCHES'		=> 'Морате доставити бар једног од агената или IP адреса за поклапање овог робота.',
