...
$lang = array_merge($lang, array(
	...
	'DOWNLOAD_ADD_IPS_EXPLAIN'		=> 'Да бисте одредили неколико различитих IP адреса или сервера унесите сваки од њих у нови ред. За одређивање опсега IP адреса одвојите почетак и крај цртицом (-), за одређивање џокера користите “*”.',
	...
	'UPLOAD_DIR_EXPLAIN'			=> 'Путања за сачувавање прилога. Молимо знајте да уколико промените ову фасциклу а имате већ додате прилоге треба да ручно копирате датотеке на њихово ново место.',
