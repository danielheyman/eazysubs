...
$lang = array_merge($lang, array(
	...
	'COLLECTED_INFORMATION_EXPLAIN'		=> 'Esta lista mostra os ficheiros que precisam de atualização. Leia as informações abaixo para ver o que tem que fazer para executar a atualização.',
	...
	'FILES_NOT_MODIFIED_EXPLAIN'		=> 'Os Ficheiros seguintes não são alterados e representam os respetivos Ficheiros originais da versão que deseja atualizar.',
	...
	'PERFORM_DATABASE_UPDATE_EXPLAIN'	=> 'Clique no botão para correr para atualizar a Base de Dados. Este script tem que ser executado separadamente porque a atualização da Base de Dados pode ter um comportamente inesperado. A atualização da Base de Dados pode demorar alguns minutos, por favor não pare a execução da mesma. Depois de finalizada a atualização da Base de Dados, feche a janela e continue o processo de atualização.',
	...
	'UPDATE_DATABASE_SCHEMA'			=> 'Atualizando o esquema da Base de Dados',
	...
	'UPDATE_VERSION_OPTIMIZE'			=> 'Atualização e optimização das Tabelas',
	'UPDATING_DATA'						=> 'Atualizando Dados',
	'UPDATING_TO_LATEST_STABLE'			=> 'Atualização da Base de Dados para o Novo Sistema',
