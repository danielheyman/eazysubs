...
$lang = array_merge($lang, array(
	...
	'FORUM_ADMIN_EXPLAIN'				=> 'V phpBB3 neexistují kategorie, všechno je založeno na fórech. Každé fórum může mít neomezený počet subfór a můžete určit, zda lze do fóra přispívat nebo ne (tj. bude se chovat jako kategorie). Kromě další akcí zde můžete přidávat, upravovat, odstraňovat, zamykat nebo odemykat jednotlivá fóra. Pokud jsou vaše příspěvky a témata nesynchronní a objevují se chyby, lze fóra také resynchronizovat. <strong>Musíte nastavit nebo zkopírovat příslušná oprávnění, aby se nová fóra zobrazila.</strong>',
