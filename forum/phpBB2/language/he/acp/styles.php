...
$lang = array_merge($lang, array(
	...
	'DELETE_STYLE_EXPLAIN'		=> 'כאן אתה יכול למחוק עיצובים. אינך יכול למחוק את כל אלמנטי עיצוב מכאן. יש למחוק אותם בנפרד מהמקומות המיועדים לכך. שים לב במהלך מחיקת העיצובים, אין אפשרות שחזור.',
